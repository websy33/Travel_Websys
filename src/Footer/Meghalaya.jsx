...
import { 
  ...
  FaPlus, FaMinus, FaMountain, FaWater, FaTree, FaHeart, FaCamera,
  FaSpa, FaUser, FaUsers, FaChild, FaHotel, FaWallet, FaExclamationCircle
} from 'react-icons/fa';
import { GiWaterfall, GiVillage, GiCaveEntrance, GiRiver, GiFlowerPot, GiShoppingBag } from 'react-icons/gi';
import { MdOutlineHiking, MdLandscape, MdFamilyRestroom, MdLocalDining, MdDirectionsBike } from 'react-icons/md';
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Meghalaya Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Meghalaya",
          booking_reference: `MEGHALAYA-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      specialFeature: "Private guided trek to living root bridges"
    },
    {
      id: 2,
      ...
      specialFeature: "Monsoon photography workshop"
    },
    {
      id: 3,
      ...
      specialFeature: "Professional caving gear provided"
    },
    {
      id: 4,
      ...
      specialFeature: "Handicraft workshop with local artisans"
    }
  ];
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <FaTree className="mr-2 text-green-300" /> ABODE OF CLOUDS
            </div>
          </motion.div>
          ...
          >
            Meghalaya <span className="text-green-200">Escapes</span>
          </motion.h1>
      ...
      <div className="bg-gradient-to-r from-green-500 to-blue-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <FaTree className="text-xl" />, text: "Living Root Bridges" },
              { icon: <GiWaterfall className="text-xl" />, text: "Majestic Waterfalls" },
              { icon: <GiCaveEntrance className="text-xl" />, text: "Cave Explorations" },
              { icon: <GiVillage className="text-xl" />, text: "Indigenous Cultures" },
              { icon: <IoMdRainy className="text-xl" />, text: "Monsoon Magic" }
            ].map((item, index) => (
              <motion.div 
                key={index}
        ...
        <div className="max-w-7xl mx-auto">
                  ...
                  >
                    ...
                    <div className="p-6">
                          ...
                          >
                            <div className="pt-4 border-t border-green-100">
                              <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                                <FaTree className="text-green-500 mr-2" /> Package Highlights:
                              </h4>
                      ...
                      <motion.button 
                        ...
                        whileTap={{ scale: 0.97 }}
                        className="w-full mt-4 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all"
          ...
          {filteredPackages.length === 0 && (
            ...
            >
              ...
              <p className="text-gray-500 mb-6">Contact us to customize your perfect Meghalaya itinerary</p>
              <button className="bg-gradient-to-r from-green-600 to-blue-600 text-white px-8 py-3 rounded-full font-medium hover:from-green-700 hover:to-blue-700 transition-all shadow-lg">
                Enquire About Meghalaya Tours
              </button>
            </motion.div>
          )}
        </div>
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="children">Number of Children</label>
                            <div className="relative flex items-center">
                              <button
                                type="button"
                                onClick={decrementChildren}
                                disabled={formData.children === 0}
                                className={`bg-gray-200 ${formData.children === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-300'} text-gray-700 font-bold py-2 px-3 rounded-l-lg`}
                              >
                                <FaMinus />
                              </button>
                              <input
                          ...
                          {formData.children > 0 && (
                            <div id="childrenAges">
                              <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="childrenAges">Children Ages (comma separated) *</label>
                              <input
                                type="text"
                                id="childrenAges"
                                name="childrenAges"
                          ...
                          <div id="budget">
                            ...
                            <div className="relative">
                              ...
                              >
                                ...
                                <option value="premium">Premium (₹70,000 - ₹1,20,000)</option>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="flex items-center">
                            <input
                              ...
                              className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                            />
                            <label htmlFor="caveExploration" className="ml-2 block text-sm text-gray-700">
                              Cave Exploration
                            </label>
                          </div>
                          ...
                          <div className="flex items-center">
                            <input
                              type="checkbox"
                              id="livingRootBridges"
                              name="livingRootBridges"
                              checked={formData.specialRequests.livingRootBridges}
                              onChange={handleSpecialRequestChange}
                              className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                            />
                            <label htmlFor="livingRootBridges" className="ml-2 block text-sm text-gray-700">
                              Living Root Bridges
                            </label>
                          </div>
                          ...
                          <div className="flex items-center">
                            <input
                              ...
                              className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                            />
                            <label htmlFor="culturalExperience" className="ml-2 block text-sm text-gray-700">
                              Cultural Experience
                            </label>
                          </div>
                          ...
                          <div className="flex items-center">
                            <input
                              ...
                              id="localCuisine"
                              name="localCuisine"
                              checked={formData.specialRequests.localCuisine}
                              onChange={handleSpecialRequestChange}
                              className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                            />
                            <label htmlFor="localCuisine" className="ml-2 block text-sm text-gray-700">
