...
import { GiKiwiBird, GiMountainRoad, GiCampfire, GiShoppingBag, GiFlowerPot } from 'react-icons/gi';
import { MdOutlineKayaking, MdFamilyRestroom, MdFlight, MdLocalDining, MdDirectionsBike } from 'react-icons/md';
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `New Zealand Tour Package - ${selectedPackage.title}`,
  ...
  const packages = [
    {
      ...
      icon: <FaStar className="text-2xl text-green-500" />,
      specialFeature: "Exclusive Maori cultural welcome ceremony"
    },
    {
      id: 2,
      ...
      icon: <FaHiking className="text-2xl text-green-500" />,
      specialFeature: "Professional adventure photography package included"
    },
    {
      id: 3,
      ...
      icon: <GiCampfire className="text-2xl text-green-500" />,
      specialFeature: "Private chef experience at luxury lodge"
    },
    {
      id: 4,
      ...
      specialFeature: "Special kids adventure pack and activities"
    },
    {
      id: 5,
      title: "North Island Wonders",
      duration: "9 Days / 8 Nights",
      price: "₹1,39,999",
      rating: 4.7,
      image: "/images/Newzealand6.jpeg",
      type: "cultural",
      highlights: [
        "Bay of Islands cruise",
        "Waitangi Treaty Grounds",
        "Rotorua Maori village experience",
        "Hobbiton Movie Set",
        "Taupo volcanic zone",
        "Wellington city tour",
        "Waiheke Island wine tasting"
      ],
      icon: <GiKiwiBird className="text-2xl text-green-500" />,
      specialFeature: "Authentic Maori hangi feast experience"
    },
    {
      id: 6,
      title: "South Island Spectacular",
      duration: "11 Days / 10 Nights",
      price: "₹1,99,999",
      rating: 4.9,
      image: "/images/Newzealand7.webp",
      type: "scenic",
      highlights: [
        "Christchurch to Queenstown scenic drive",
        "Franz Josef Glacier hike",
        "Milford Sound overnight cruise",
        "Wanaka tree photography",
        "Doubtful Sound wilderness",
        "Mount Cook national park",
        "Kaikoura whale watching"
      ],
      icon: <FaMountain className="text-2xl text-green-500" />,
      specialFeature: "Stargazing experience at Tekapo Dark Sky Reserve"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-blue-50">
      ...
      <div className="relative h-screen max-h-[800px] overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-green-900/60 to-blue-700/50"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <GiKiwiBird className="mr-2 text-green-300" /> PURE NEW ZEALAND
            </div>
          </motion.div>
          ...
          >
            New Zealand <span className="text-green-200">Adventure</span>
          </motion.h1>
          ...
          >
            Where breathtaking landscapes meet thrilling adventures in Middle Earth
          </motion.p>
      ...
      <div className="bg-gradient-to-r from-green-500 to-blue-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <FaHiking className="text-xl" />, text: "Adventure Sports" },
              { icon: <FaCamera className="text-xl" />, text: "Scenic Photography" },
              { icon: <MdLocalDining className="text-xl" />, text: "Wine & Cuisine" },
              { icon: <GiShoppingBag className="text-xl" />, text: "Maori Crafts" },
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">New Zealand Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the magic of Middle Earth with our specially curated packages featuring exclusive adventures
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'adventure', 'luxury', 'family', 'cultural', 'scenic'].map((tab) => (
            <motion.button
              key={tab}
                        ...
                        >
                          <div className="pt-4 border-t border-green-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <GiKiwiBird className="text-green-500 mr-2" /> Package Highlights:
                            </h4>
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect New Zealand itinerary</p>
            <button className="bg-gradient-to-r from-green-500 to-blue-600 text-white px-8 py-3 rounded-full font-medium hover:from-green-600 hover:to-blue-700 transition-all shadow-lg">
              Enquire About New Zealand Tours
            </button>
          </motion.div>
        )}
      </div>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-50 to-blue-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Local Kiwi Experts",
                description: "Our team has extensive experience in New Zealand tourism",
                icon: "🧔",
                bg: "bg-green-100"
              },
              {
                title: "Best Adventure Partners",
                description: "Certified operators for all adventure activities",
                icon: "🛶",
                bg: "bg-blue-100"
              },
              {
      ...
      {/* New Zealand Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore New Zealand's Beauty</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {galleryImages.map((image, index) => (
              ...
              >
                <img 
                  src={image} 
                  alt={`New Zealand scenery ${index + 1}`} 
                        ...
                        <div id="budget">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="mid-range">Mid-Range (₹2,00,000 - ₹4,00,000)</option>
                              <option value="premium">Premium (₹4,00,000 - ₹6,00,000)</option>
                              <option value="luxury">Luxury (₹6,00,000+)</option>
                            </select>
                            {formErrors.budget && (
                              <div className="absolute right-3 top-3 text-red-500">
                                <FaExclamationCircle />
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="maoriCulturalShow"
                            name="maoriCulturalShow"
                            checked={formData.specialRequests.maoriCulturalShow}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                          />
                          <label htmlFor="maoriCulturalShow" className="ml-2 block text-sm text-gray-700">
                            Maori Cultural Show
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="glacierHiking"
                            name="glacierHiking"
                            checked={formData.specialRequests.glacierHiking}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                          />
                          <label htmlFor="glacierHiking" className="ml-2 block text-sm text-gray-700">
                            Glacier Hiking
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="hobbitonTour"
                            name="hobbitonTour"
                            checked={formData.specialRequests.hobbitonTour}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                          />
                          <label htmlFor="hobbitonTour" className="ml-2 block text-sm text-gray-700">
                            Hobbiton Tour
                          </label>
                        </div>
                      </div>
