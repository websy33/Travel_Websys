  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Andaman Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Andaman and Nicobar Islands",
          booking_reference: `ANDAMAN-${Date.now()}`,
                        ...
                        <div id="budget">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="economy">Economy (₹30,000 - ₹50,000)</option>
                              <option value="mid-range">Mid-Range (₹50,000 - ₹80,000)</option>
                              <option value="premium">Premium (₹80,000 - ₹1,20,000)</option>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="seaWalk" className="ml-2 block text-sm text-gray-700">
                            Sea Walk
                          </label>
                        </div>
