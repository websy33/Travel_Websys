...
import { 
  ...
  FaUser, FaWallet, FaHotel, FaHeart, FaCamera, FaSpa, FaExclamationCircle
} from 'react-icons/fa';
import { GiModernCity, GiIsland, GiShoppingBag, GiFlowerPot } from 'react-icons/gi';
import { MdOutlineBeachAccess, MdFamilyRestroom, MdTempleHindu, MdLocalDining, MdDirectionsBike } from 'react-icons/md';
...
const Kazakhstan = () => {
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Kazakhstan Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Kazakhstan",
          booking_reference: `KAZAKHSTAN-${Date.now()}`,
  ...
  const packages = [
    ...
    },
    {
      ...
      icon: <GiModernCity className="text-2xl text-blue-500" />,
      specialFeature: "Private dinner at a traditional Kazakh yurt with live music"
    },
    {
      id: 3,
    ...
    },
    {
      ...
      price: "₸420,000",
      rating: 4.8,
      image: "/images/Kazakistan5.jpeg",
      type: "cultural",
      highlights: [
        "Ancient Silk Road sites",
        "Traditional Kazakh crafts workshops",
      ...
      icon: <FaLandmark className="text-2xl text-blue-500" />,
      specialFeature: "Hands-on traditional Kazakh craft workshop"
    },
    {
      id: 6,
      title: "Winter Wonderland Kazakhstan",
      duration: "6 Days / 5 Nights",
      price: "₸490,000",
      rating: 4.7,
      image: "/images/Kazakistan6.jpeg",
      type: "winter",
      highlights: [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <FaMountain className="mr-2 text-blue-300" /> HEART OF CENTRAL ASIA
            </div>
          </motion.div>
          ...
          >
            Kazakhstan <span className="text-purple-200">Exploration</span>
          </motion.h1>
          ...
          >
            Where endless steppes meet modern cities in Central Asia's largest country
          </motion.p>
          ...
          >
            <div className="animate-bounce text-purple-200 text-2xl">
              <FaChevronDown />
            </div>
          </motion.div>
        </div>
      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <FaCity className="text-xl" />, text: "Modern Cities" },
              { icon: <FaCamera className="text-xl" />, text: "Scenic Landscapes" },
              { icon: <MdLocalDining className="text-xl" />, text: "Kazakh Cuisine" },
              { icon: <GiShoppingBag className="text-xl" />, text: "Silk Road Crafts" },
              { icon: <FaSpa className="text-xl" />, text: "Cultural Heritage" }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Kazakhstan Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the vast beauty of Kazakhstan with our specially curated packages featuring exclusive cultural experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'luxury', 'family', 'adventure', 'cultural', 'winter'].map((tab) => (
            <motion.button
              key={tab}
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="w-full mt-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all"
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Kazakhstan itinerary</p>
            <button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-3 rounded-full font-medium hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg">
              Enquire About Kazakhstan Tours
            </button>
          </motion.div>
        )}
      </div>
            ...
            {[
              {
                ...
                description: "Our team has deep knowledge of Kazakhstan's diverse regions",
                icon: "🧔",
                bg: "bg-blue-100"
              },
              {
                title: "Best Cultural Guides",
                description: "Certified guides for authentic cultural experiences",
                icon: "🏔️",
                bg: "bg-purple-100"
              },
              {
      ...
      {/* Kazakhstan Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Kazakhstan's Beauty</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {galleryImages.map((image, index) => (
              ...
              >
                <img 
                  src={image} 
                  alt={`Kazakhstan scenery ${index + 1}`} 
      ...
      {showBookingForm && selectedPackage && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="sticky top-0 bg-gradient-to-r from-blue-500 to-purple-600 p-4 flex justify-between items-center z-10">
              ...
              {formSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <motion.button 
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-3 rounded-lg font-medium shadow-lg`}
                    onClick={() => setShowBookingForm(false)}
                  >
                    Close
                  </motion.button>
                  ...
                  <form onSubmit={handleSubmit}>
                        ...
                        <div id="budget">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="economy">Economy (₸300,000 - ₸500,000)</option>
                              <option value="mid-range">Mid-Range (₸500,000 - ₸800,000)</option>
                              <option value="premium">Premium (₸800,000 - ₸1,200,000)</option>
                              <option value="luxury">Luxury (₸1,200,000+)</option>
                            </select>
                            {formErrors.budget && (
                              <div className="absolute right-3 top-3 text-red-500">
                                <FaExclamationCircle />
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          ...
                          />
                          <label htmlFor="cityTour" className="ml-2 block text-sm text-gray-700">
                            City Tours
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="natureExperiences"
                            name="natureExperiences"
                            checked={formData.specialRequests.natureExperiences}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="natureExperiences" className="ml-2 block text-sm text-gray-700">
                            Nature Experiences
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="traditionalCuisine"
                            name="traditionalCuisine"
                            checked={formData.specialRequests.traditionalCuisine}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="traditionalCuisine" className="ml-2 block text-sm text-gray-700">
                            Traditional Cuisine
                          </label>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <motion.button
                        ...
                        className={`w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white py-3 rounded-lg font-bold transition-all duration-200 shadow-lg ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
