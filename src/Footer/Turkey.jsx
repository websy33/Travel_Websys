...
import { 
  ...
  FaBus, FaTrain, FaPlane, FaSun, FaMosque, FaHeart, FaCamera,
  FaSpa, FaUser, FaExclamationCircle, FaWallet, FaHotel, FaUsers,
  FaChild, FaCalendarAlt as FaCalendar
} from 'react-icons/fa';
import { GiModernCity, GiCastle, GiShoppingBag, GiAncientColumns, GiFlowerPot } from 'react-icons/gi';
import { MdOutlineBeachAccess, MdFamilyRestroom, MdSpa, MdLocalDining, MdDirectionsBike } from 'react-icons/md';
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Turkey Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Turkey",
          booking_reference: `TURKEY-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      specialFeature: "Sunset hot air balloon ride over Cappadocia"
    },
    {
      id: 2,
      ...
      specialFeature: "Private Turkish bath experience with rose oil"
    },
    {
      id: 3,
      ...
      specialFeature: "Family Turkish cooking class"
    },
    {
      id: 4,
      ...
      specialFeature: "Private beach dinner with Turkish meze"
    },
    {
      id: 5,
      ...
      price: "₹1,29,999",
      rating: 4.9,
      image: "/images/Turkey5.jpeg",
      type: "honeymoon",
      highlights: [
        "Romantic cave suite in Cappadocia",
        "Private hot air balloon ride for two",
        "Sunset cruise on Bosphorus",
        "Couple's hamam spa treatment",
        "Candlelight dinner in ancient ruins",
        "Luxury resort in Antalya",
        "Professional couple photoshoot"
      ],
      icon: <FaHeart className="text-2xl text-red-500" />,
      specialFeature: "Rose petal turndown service in cave hotel"
    },
    {
      id: 6,
      ...
      price: "₹99,999",
      rating: 4.8,
      image: "/images/Turkey6.jpeg",
      type: "cultural",
      highlights: [
        "Comprehensive historical site visits",
        "Traditional Turkish arts workshops",
        "Local village experiences",
        "Museum tours with expert guides",
        "Cultural performances",
        "Handicraft market visits",
        "Authentic culinary experiences"
      ],
      icon: <GiAncientColumns className="text-2xl text-amber-600" />,
      specialFeature: "Private access to restricted archaeological areas"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <GiAncientColumns className="mr-2 text-purple-300" /> WHERE EAST MEETS WEST
            </div>
          </motion.div>
          ...
          >
            Discover <span className="text-purple-200">Turkey</span>
          </motion.h1>
          ...
          >
            From ancient ruins to stunning beaches, experience the perfect blend of history and natural beauty
          </motion.p>
      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <GiAncientColumns className="text-xl" />, text: "Historical Sites" },
              { icon: <MdOutlineBeachAccess className="text-xl" />, text: "Stunning Beaches" },
              { icon: <IoMdRestaurant className="text-xl" />, text: "Turkish Cuisine" },
              { icon: <GiShoppingBag className="text-xl" />, text: "Grand Bazaars" },
              { icon: <MdSpa className="text-xl" />, text: "Hammam Spas" }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Turkey Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the magic of Turkey with our specially curated packages featuring exclusive experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'luxury', 'family', 'beach', 'honeymoon', 'cultural'].map((tab) => (
            <motion.button
              key={tab}
                        ...
                        >
                          <div className="pt-4 border-t border-blue-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <GiAncientColumns className="text-blue-500 mr-2" /> Package Highlights:
                            </h4>
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Turkey itinerary</p>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Local Turkish Experts",
                description: "Our team has extensive experience in Turkey",
                icon: "🧔",
                bg: "bg-blue-100"
              },
              {
      ...
      {/* Turkey Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Turkey's Beauty</h2>
                  ...
                  <form onSubmit={handleSubmit}>
                        ...
                        <div id="budget">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="economy">Economy (₹70,000 - ₹1,00,000)</option>
                              <option value="mid-range">Mid-Range (₹1,00,000 - ₹1,50,000)</option>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            checked={formData.specialRequests.historicalTours}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="historicalTours" className="ml-2 block text-sm text-gray-700">
                            Historical Tours
                          </label>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <motion.button
                        ...
                        className={`w-full bg-gradient-to-r from-green-500 to-teal-600 hover:from-green-600 hover:to-teal-700 text-white py-3 rounded-lg font-bold transition-all duration-200 shadow-lg ${isProcessing || !razorpayLoaded ? 'opacity-50 cursor-not-allowed' : ''}`}
