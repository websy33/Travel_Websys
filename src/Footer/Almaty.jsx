...
import { 
  ...
  FaUtensils, FaUser, FaWallet, FaHotel, FaHeart, FaCamera, FaSpa, FaExclamationCircle
} from 'react-icons/fa';
import { GiMoneyStack, GiNightSky, GiCampingTent, GiShoppingBag, GiFlowerPot } from 'react-icons/gi';
import { MdCasino, MdOutlineHiking, MdFamilyRestroom, MdLocalDining, MdDirectionsBike } from 'react-icons/md';
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Almaty Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Almaty, Kazakhstan",
          booking_reference: `ALMATY-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      highlights: [
        ...
        "Traditional Kazakh dinner experience"
      ],
      icon: <FaStar className="text-2xl text-blue-500" />,
      specialFeature: "Exclusive traditional Kazakh eagle hunting demonstration"
    },
    {
      id: 2,
      ...
      specialFeature: "Private dinner at a traditional Kazakh yurt"
    },
    {
      id: 3,
      ...
      specialFeature: "Professional photography session in Charyn Canyon"
    },
    {
      id: 4,
      ...
      specialFeature: "Hands-on traditional Kazakh craft workshop"
    },
    {
      id: 5,
      title: "Almaty Winter Wonderland",
      duration: "5 Days / 4 Nights",
      price: "₹59,999",
      rating: 4.6,
      image: "/images/Almaty5.jpeg",
      type: "winter",
      highlights: [
        "Skiing and snowboarding at Shymbulak",
        "Ice skating at Medeu",
        "Winter hiking in Tian Shan",
        "Traditional Kazakh winter activities",
        "Hot springs experience",
        "Winter photography tour"
      ],
      icon: <IoMdSnow className="text-2xl text-blue-500" />,
      specialFeature: "Private ice skating session at Medeu Skating Rink"
    },
    {
      id: 6,
      title: "Almaty Family Adventure",
      duration: "6 Days / 5 Nights",
      price: "₹49,999",
      rating: 4.7,
      image: "/images/Almaty6.jpg",
      type: "family",
      highlights: [
        "Kid-friendly city tours",
        "Almaty Zoo visit",
      ...
      specialFeature: "Special children's cultural immersion activities"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-amber-50">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <FaMountain className="mr-2 text-blue-300" /> GARDEN CITY OF KAZAKHSTAN
            </div>
          </motion.div>
          ...
          >
            Almaty <span className="text-amber-200">Adventure</span>
          </motion.h1>
          ...
          >
            Where urban sophistication meets breathtaking mountain landscapes in Kazakhstan's cultural capital
          </motion.p>
      ...
      <div className="bg-gradient-to-r from-blue-500 to-amber-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <FaMountain className="text-xl" />, text: "Mountain Adventures" },
              { icon: <FaCamera className="text-xl" />, text: "Scenic Photography" },
              { icon: <MdLocalDining className="text-xl" />, text: "Kazakh Cuisine" },
              { icon: <GiShoppingBag className="text-xl" />, text: "Local Crafts" },
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Almaty Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the magic of Almaty with our specially curated packages featuring exclusive cultural experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'luxury', 'adventure', 'heritage', 'winter', 'family'].map((tab) => (
            <motion.button
              key={tab}
                        ...
                        >
                          <div className="pt-4 border-t border-blue-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <FaMountain className="text-blue-500 mr-2" /> Package Highlights:
                            </h4>
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Almaty itinerary</p>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-50 to-amber-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Local Kazakh Experts",
                description: "Our team has deep knowledge of Almaty and Kazakhstan",
                icon: "🧔",
                bg: "bg-blue-100"
              },
              {
                title: "Best Mountain Guides",
                description: "Certified guides for Tian Shan mountain adventures",
                icon: "🏔️",
                bg: "bg-amber-100"
              },
              {
      ...
      {/* Almaty Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Almaty's Beauty</h2>
                        ...
                        <div id="budget">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="mid-range">Mid-Range (₹60,000 - ₹1,00,000)</option>
                              <option value="premium">Premium (₹1,00,000 - ₹2,00,000)</option>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          ...
                          />
                          <label htmlFor="shopping" className="ml-2 block text-sm text-gray-700">
                            Shopping Focus
                          </label>
                        </div>
