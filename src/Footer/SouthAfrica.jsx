...
import { 
  ...
  FaUsers, FaChild, FaHotel, FaUtensils, FaWallet, FaPlus, FaMinus, FaExclamationCircle 
} from 'react-icons/fa';
import { GiLion, GiCampingTent, GiElephant, GiMoneyStack } from 'react-icons/gi';
import { MdFamilyRestroom, MdOutlineWineBar, MdBeachAccess, MdOutlineHiking } from 'react-icons/md';
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `South Africa Tour Package - ${selectedPackage.title}`,
  ...
  const packages = [
    {
      ...
      icon: <GiLion className="text-2xl text-amber-600" />,
      specialFeature: "Exclusive safari vehicle with professional tracker"
    },
    {
      id: 2,
      ...
      specialFeature: "Private butler service at luxury lodges"
    },
    {
      id: 3,
      ...
      icon: <MdFamilyRestroom className="text-2xl text-amber-600" />,
      specialFeature: "Child-friendly safari guides and activities"
    },
    {
      id: 4,
      ...
      icon: <MdOutlineHiking className="text-2xl text-amber-600" />,
      specialFeature: "Adventure activity coordinator"
    },
    {
      id: 5,
      title: "Wine & Wildlife Experience",
      duration: "8 Days / 7 Nights",
      price: "₹1,89,999",
      rating: 4.8,
      image: "/images/SA5.jpeg",
      type: "luxury",
      highlights: [
        "Private wine tours in Stellenbosch and Franschhoek",
        "Luxury safari in private game reserve",
      ...
      icon: <MdOutlineWineBar className="text-2xl text-amber-600" />,
      specialFeature: "Private wine expert and sommelier"
    },
    {
      id: 6,
      title: "Coastal & Safari Discovery",
      duration: "11 Days / 10 Nights",
      price: "₹1,69,999",
      rating: 4.7,
      image: "/images/SA6.jpeg",
      type: "popular",
      highlights: [
        "Cape Town coastal exploration",
        "Table Mountain and Cape Point",
        "Safari in malaria-free reserve",
        "Garden Route highlights",
        "Whale watching (seasonal)",
        "Beach relaxation time",
        "Coastal drive experiences",
        "Marine wildlife encounters"
      ],
      icon: <MdBeachAccess className="text-2xl text-amber-600" />,
      specialFeature: "Coastal and marine expert guide"
    }
  ];

  const southAfricaImages = [
    "/images/SA1.jpeg",
    "/images/SA2.jpeg",
    "/images/SA3.jpeg",
    "/images/SA4.jpeg",
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-yellow-50">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <GiLion className="mr-2 text-amber-300" /> RAINBOW NATION
            </div>
          </motion.div>
          ...
          >
            South Africa <span className="text-amber-200">Safari</span> Adventures
          </motion.h1>
          ...
          >
            Where the Big Five roam and vibrant cultures thrive in Africa's most diverse destination
          </motion.p>
      ...
      <div className="bg-gradient-to-r from-amber-500 to-yellow-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <GiLion className="text-xl" />, text: "Big Five Safaris" },
              { icon: <FaCamera className="text-xl" />, text: "Wildlife Photography" },
              { icon: <MdOutlineWineBar className="text-xl" />, text: "Wine Tasting" },
              { icon: <MdBeachAccess className="text-xl" />, text: "Coastal Beauty" },
              { icon: <FaSpa className="text-xl" />, text: "Luxury Lodges" }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">South Africa Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the magic of South Africa with our specially curated packages featuring exclusive safari experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'luxury', 'family', 'adventure'].map((tab) => (
            <motion.button
              key={tab}
                        ...
                        >
                          <div className="pt-4 border-t border-amber-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <GiLion className="text-amber-500 mr-2" /> Package Highlights:
                            </h4>
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect South Africa itinerary</p>
            <button className="bg-gradient-to-r from-amber-500 to-yellow-600 text-white px-8 py-3 rounded-full font-medium hover:from-amber-600 hover:to-yellow-700 transition-all shadow-lg">
              Enquire About South Africa Tours
            </button>
          </motion.div>
        )}
      </div>
            ...
            {[
              {
                ...
                description: "Professional guides with wildlife tracking skills",
                icon: "🦁",
                bg: "bg-amber-100"
              },
              {
                title: "Conservation Focus",
                description: "Supporting ethical wildlife experiences",
                icon: "🐘",
                bg: "bg-yellow-100"
              },
              {
                title: "Seamless Logistics",
                description: "Domestic flights and transfers coordinated",
                icon: "✈️",
                bg: "bg-orange-100"
              }
            ].map((feature, index) => (
      ...
      {/* South Africa Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore South Africa's Diversity</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {southAfricaImages.map((image, index) => (
              <motion.div
                key={index}
              ...
              >
                <img 
                  src={image} 
                  alt={`South Africa scenery ${index + 1}`} 
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="luxury">Luxury Camp</option>
                            </select>
                          </div>
                        </div>
                        ...
                        <div id="budget">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="economy">Economy (₹1,00,000 - ₹1,50,000)</option>
                              <option value="mid-range">Mid-Range (₹1,50,000 - ₹2,50,000)</option>
                              <option value="premium">Premium (₹2,50,000 - ₹4,00,000)</option>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          <input
                            ...
                            id="safariFocus"
                            name="safariFocus"
                            checked={formData.specialRequests.safariFocus}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 rounded"
                          />
                          <label htmlFor="safariFocus" className="ml-2 block text-sm text-gray-700">
                            Safari Focus
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="wineExperiences"
                            name="wineExperiences"
                            checked={formData.specialRequests.wineExperiences}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 rounded"
                          />
                          <label htmlFor="wineExperiences" className="ml-2 block text-sm text-gray-700">
                            Wine Experiences
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="beachTime"
                            name="beachTime"
                            checked={formData.specialRequests.beachTime}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 rounded"
                          />
                          <label htmlFor="beachTime" className="ml-2 block text-sm text-gray-700">
                            Beach Time
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            checked={formData.specialRequests.adventureActivities}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 rounded"
                          />
                          <label htmlFor="adventureActivities" className="ml-2 block text-sm text-gray-700">
