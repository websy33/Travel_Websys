  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Lakshadweep Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Lakshadweep Islands",
          booking_reference: `LAKSHADWEEP-${Date.now()}`,
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-teal-50">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-blue-600 to-teal-600 text-white px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all text-lg hover:brightness-110"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 font-serif">India's Coral Paradise</h2>
      ...
      {/* Lakshadweep Stats Section */}
      <section className="py-16 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { number: "36", label: "Islands", icon: <GiIsland className="text-3xl mx-auto mb-3" /> },
              { number: "4,200", label: "Square KM", icon: <FaMapMarkerAlt className="text-3xl mx-auto mb-3" /> },
              { number: "100+", label: "Coral Species", icon: <FaFish className="text-3xl mx-auto mb-3" /> },
              { number: "0", label: "Crowds", icon: <FaUmbrella className="text-3xl mx-auto mb-3" /> }
            ].map((stat, index) => (
              <motion.div 
                key={index}
                initial={{ opacity: 0 }}
      ...
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 font-serif">Island Packages</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            {[
              ...
              { id: 'adventure', label: 'Adventure', icon: <FaSwimmer className="mr-2" /> },
              { id: 'luxury', label: 'Luxury', icon: <GiIsland className="mr-2" /> },
              { id: 'family', label: 'Family', icon: <MdBeachAccess className="mr-2" /> }
            ].map(tab => (
              <motion.button
                key={tab.id}
                whileHover={{ scale: 1.05 }}
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 font-serif">Island Paradise</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-16 px-4 bg-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 font-serif">Why Choose Our Island Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-teal-500 mx-auto mb-6 rounded-full"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <GiSailboat className="text-5xl text-blue-600" />,
              ...
              {
                icon: <GiSeaTurtle className="text-5xl text-green-600" />,
              ...
              {
                icon: <IoMdRestaurant className="text-5xl text-blue-500" />,
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <MdDining className="absolute left-3 top-3 text-gray-400" />
                            <select
                              id="mealsIncluded"
                              name="mealsIncluded"
                        ...
                        <div id="budget">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="economy">Economy (₹35,000 - ₹50,000)</option>
                              <option value="mid-range">Mid-Range (₹50,000 - ₹75,000)</option>
                              <option value="premium">Premium (₹75,000 - ₹1,00,000)</option>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          ...
                          />
                          <label htmlFor="diving" className="ml-2 block text-sm text-gray-700">
                            Scuba Diving
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="snorkeling" className="ml-2 block text-sm text-gray-700">
                            Snorkeling
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="kayaking" className="ml-2 block text-sm text-gray-700">
                            Kayaking
                          </label>
                        </div>
