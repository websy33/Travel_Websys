...
import { 
  FaStar, FaHeart, FaUmbrellaBeach, FaChevronDown, FaTimes, 
  FaPhone, FaEnvelope, FaMapMarkerAlt, FaPlus, FaMinus,
  FaUser, FaWallet, FaHotel, FaCalendarAlt, FaUtensils,
  FaExclamationCircle
} from 'react-icons/fa';
...
const Bali = () => {
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Bali Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Bali",
          booking_reference: `BALI-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      specialFeature: "Private Balinese offering making session with local priest"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      highlights: [
        ...
        "Healing water temple visit",
        "Private wellness consultation",
        "Chakra balancing therapy"
      ],
      icon: <MdSpa className="text-2xl text-green-500" />,
      specialFeature: "Personalized wellness program with certified therapist"
    },
    {
      id: 4,
      ...
      highlights: [
        ...
        "Traditional village cycling tour",
        "White water rafting in Ayung River"
      ],
      icon: <GiWaterfall className="text-2xl text-cyan-500" />,
      specialFeature: "GoPro footage of all adventure activities included"
    },
    {
      id: 5,
      ...
      type: "luxury",
      highlights: [
        "Private pool villa with butler service",
      ...
      specialFeature: "Honeymoon photo shoot with professional photographer"
    },
    {
      id: 6,
      title: "Family Fun Experience",
      duration: "6 Days / 5 Nights",
      price: "₹82,999",
      rating: 4.7,
      ...
      type: "family",
      highlights: [
        "Family-friendly water villa",
        "Bali Safari and Marine Park",
        "Waterbom Bali waterpark",
        "Traditional kite making workshop",
        "Family cooking class",
        "Beach games and activities"
      ],
      icon: <MdFamilyRestroom className="text-2xl text-purple-500" />,
      specialFeature: "Private family photographer for entire trip"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-amber-50">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <GiIsland className="mr-2 text-amber-300" /> ISLAND OF GODS
            </div>
          </motion.div>
          ...
          >
            Bali <span className="text-amber-200">Paradise</span>
          </motion.h1>
          ...
          >
            Where ancient temples meet pristine beaches in Indonesia's tropical paradise
          </motion.p>
      ...
      <div className="bg-gradient-to-r from-green-500 to-amber-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <GiTempleGate className="text-xl" />, text: "Ancient Temples" },
              { icon: <FaUmbrellaBeach className="text-xl" />, text: "Pristine Beaches" },
              { icon: <MdSpa className="text-xl" />, text: "Luxury Spas" },
              { icon: <GiWaterfall className="text-xl" />, text: "Waterfalls" },
              { icon: <MdOutlineSurfing className="text-xl" />, text: "Surfing" }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Bali Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the magic of Bali with our specially curated packages featuring exclusive tropical experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'culture', 'beach', 'wellness', 'adventure', 'luxury', 'family'].map((tab) => (
            <motion.button
              key={tab}
              ...
              className={`px-5 py-3 rounded-full text-sm font-medium capitalize transition-all ${activeTab === tab 
                ? 'bg-gradient-to-r from-green-500 to-amber-600 text-white shadow-lg' 
                ...
                >
                  ...
                  <div className="p-6">
                        ...
                        >
                          <div className="pt-4 border-t border-green-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <GiTempleGate className="text-green-500 mr-2" /> Package Highlights:
                            </h4>
                    ...
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="w-full mt-4 bg-gradient-to-r from-green-500 to-amber-600 hover:from-green-600 hover:to-amber-700 text-white py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all"
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Bali itinerary</p>
            <button className="bg-gradient-to-r from-green-500 to-amber-600 text-white px-8 py-3 rounded-full font-medium hover:from-green-600 hover:to-amber-700 transition-all shadow-lg">
              Enquire About Bali Tours
            </button>
          </motion.div>
        )}
      </div>
            ...
            {[
              {
                ...
                description: "Our team has lived in Bali for generations",
                icon: "🧔",
                bg: "bg-green-100"
              },
              {
                title: "Luxury Villa Partners",
              ...
              },
              {
                ...
                description: "Authentic experiences beyond tourist spots",
                icon: "🌺",
                bg: "bg-orange-100"
              }
            ].map((feature, index) => (
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Bali's Beauty</h2>
      ...
      {showBookingForm && selectedPackage && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="sticky top-0 bg-gradient-to-r from-green-500 to-amber-600 p-4 flex justify-between items-center z-10">
              ...
              {formSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <motion.button 
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`bg-gradient-to-r from-green-500 to-amber-600 text-white px-8 py-3 rounded-lg font-medium shadow-lg`}
                    onClick={() => setShowBookingForm(false)}
                  >
                    Close
                  </motion.button>
                ...
                <>
                  ...
                  <div className="mb-6 p-4 bg-gradient-to-r from-green-50 to-amber-50 rounded-lg border border-green-100">
                  ...
                  <form onSubmit={handleSubmit}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                          />
                          <label htmlFor="flowerDecor" className="ml-2 block text-sm text-gray-700">
                            Flower Decoration
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                          />
                          <label htmlFor="privateBoat" className="ml-2 block text-sm text-gray-700">
                            Private Boat
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                          />
                          <label htmlFor="ayurvedaSession" className="ml-2 block text-sm text-gray-700">
                            Ayurveda Session
                          </label>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <motion.button
                        ...
                        className={`w-full bg-gradient-to-r from-green-500 to-amber-600 hover:from-green-600 hover:to-amber-700 text-white py-3 rounded-lg font-bold transition-all duration-200 shadow-lg ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
