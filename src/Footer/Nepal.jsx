...
import { 
  ...
  FaHiking, FaPrayingHands, FaHotel, FaHeart, FaCamera, FaSpa,
  FaUser, FaWallet, FaExclamationCircle
} from 'react-icons/fa';
import { GiElephant, GiTempleGate, GiShoppingBag, GiVillage, GiFlowerPot } from 'react-icons/gi';
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Nepal Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Nepal",
          booking_reference: `NEPAL-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      specialFeature: "Exclusive cultural immersion with local communities"
    },
    {
      id: 2,
      ...
      specialFeature: "Professional mountain guide and safety equipment included"
    },
    {
      id: 3,
      ...
      specialFeature: "Child-friendly activities and special meals for kids"
    },
    {
      id: 4,
      ...
      specialFeature: "Luxury accommodations with private butler service"
    },
    {
      id: 5,
      title: "Spiritual Nepal Journey",
      duration: "6 Days / 5 Nights",
      price: "$799",
      rating: 4.8,
      image: "/images/Nepal5.jpg",
      type: "spiritual",
      highlights: [
        "Lumbini - Birthplace of Buddha",
        "Meditation sessions in monasteries",
        "Pashupatinath Temple ceremonies",
        "Boudhanath Stupa circumambulation",
        "Yoga sessions with Himalayan views",
        "Ayurvedic wellness treatments",
        "Spiritual guide throughout the journey"
      ],
      icon: <FaPrayingHands className="text-2xl text-amber-600" />,
      specialFeature: "Private meditation sessions with Buddhist monks"
    },
    {
      id: 6,
      title: "Adventure Nepal Extreme",
      duration: "12 Days / 11 Nights",
      price: "$1,599",
      rating: 4.7,
      image: "/images/Nepal6.jpeg",
      type: "adventure",
      highlights: [
        "White water rafting in Trishuli River",
        "Paragliding in Pokhara",
        "Bungee jumping at The Last Resort",
        "Mountain biking around Kathmandu Valley",
        "Jungle safari in Bardia National Park",
        "Zip lining in Pokhara",
        "Rock climbing near Kathmandu"
      ],
      icon: <MdOutlineHiking className="text-2xl text-red-500" />,
      specialFeature: "All adventure equipment and safety gear provided"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-green-50">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <FaMountain className="mr-2 text-green-300" /> LAND OF THE HIMALAYAS
            </div>
          </motion.div>
          ...
          >
            Nepal <span className="text-green-200">Adventure</span> Awaits
          </motion.h1>
          ...
          >
            Where ancient traditions meet Himalayan adventures in the roof of the world
          </motion.p>
      ...
      <div className="bg-gradient-to-r from-green-500 to-blue-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <FaHiking className="text-xl" />, text: "Trekking Adventures" },
              { icon: <GiTempleGate className="text-xl" />, text: "Spiritual Journeys" },
              { icon: <GiElephant className="text-xl" />, text: "Wildlife Safaris" },
              { icon: <GiShoppingBag className="text-xl" />, text: "Local Handicrafts" },
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Nepal Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the magic of Nepal with our specially curated packages featuring exclusive Himalayan experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'trekking', 'family', 'luxury', 'spiritual', 'adventure'].map((tab) => (
            <motion.button
              key={tab}
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Nepal itinerary</p>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-50 to-green-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Local Nepali Experts",
                description: "Our team has extensive experience in Nepal tourism",
                icon: "🧔",
                bg: "bg-green-100"
              },
              {
                title: "Trekking Specialists",
                description: "Certified guides for Himalayan adventures",
                icon: "🥾",
                bg: "bg-blue-100"
              },
              {
                title: "Sustainable Tourism",
                description: "Supporting local communities and environment",
                icon: "🌱",
                bg: "bg-teal-100"
              }
            ].map((feature, index) => (
      ...
      {/* Nepal Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Nepal's Beauty</h2>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                          />
                          <label htmlFor="wildlife" className="ml-2 block text-sm text-gray-700">
                            Wildlife Safari
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                          />
                          <label htmlFor="spiritual" className="ml-2 block text-sm text-gray-700">
                            Spiritual Sites
                          </label>
                        </div>
