  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Vietnam Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Vietnam",
          booking_reference: `VIETNAM-${Date.now()}`,
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-orange-50">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
          <div className="text-center max-w-4xl">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-red-600 to-yellow-600 text-white px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all text-lg hover:brightness-110"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 font-serif">The Essence of Vietnam</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <GiPagoda className="text-5xl text-red-600" />,
            ...
            {
              icon: <GiRiceCooker className="text-5xl text-amber-700" />,
      ...
      {/* Vietnam Stats Section */}
      <section className="py-16 bg-gradient-to-r from-red-600 to-yellow-600 text-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { number: "8", label: "UNESCO Sites", icon: <GiPagoda className="text-3xl mx-auto mb-3" /> },
              { number: "3,260", label: "KM Coastline", icon: <FaWater className="text-3xl mx-auto mb-3" /> },
              { number: "54", label: "Ethnic Groups", icon: <MdFamilyRestroom className="text-3xl mx-auto mb-3" /> },
              { number: "100+", label: "Dishes to Try", icon: <GiRiceCooker className="text-3xl mx-auto mb-3" /> }
            ].map((stat, index) => (
              <motion.div 
                key={index}
                initial={{ opacity: 0 }}
      ...
      {/* Packages Section */}
      <section id="packages" className="py-16 px-4 bg-gradient-to-b from-white to-orange-50 relative overflow-hidden">
        <div className="absolute -top-20 -right-20 w-64 h-64 bg-red-100 rounded-full opacity-20"></div>
        <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-yellow-100 rounded-full opacity-20"></div>
        
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 font-serif">Vietnam Tour Packages</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-yellow-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            {[
              ...
              { id: 'popular', label: 'Popular', icon: <FaStar className="mr-2" /> },
              { id: 'heritage', label: 'Heritage', icon: <GiPagoda className="mr-2" /> },
              { id: 'adventure', label: 'Adventure', icon: <FaMotorcycle className="mr-2" /> },
              { id: 'luxury', label: 'Luxury', icon: <GiIsland className="mr-2" /> }
            ].map(tab => (
              <motion.button
                key={tab.id}
                whileHover={{ scale: 1.05 }}
            ...
            {filteredPackages.map(pkg => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                  className="bg-white rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow group border border-gray-100"
                >
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4">
                      <div className="bg-red-600/90 text-white px-3 py-1 rounded-full text-sm font-medium shadow-md">
                        {pkg.duration}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center mb-4">
                      <div className="mr-3 p-2 bg-red-100 rounded-lg shadow-inner">
                        {pkg.icon}
                      </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-orange-50 to-white relative overflow-hidden">
        <div className="absolute -top-20 -left-20 w-64 h-64 bg-yellow-100 rounded-full opacity-20"></div>
        <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-red-100 rounded-full opacity-20"></div>
        
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 font-serif">Vietnam Through Our Lens</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-yellow-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-16 px-4 bg-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 font-serif">Why Choose Our Vietnam Tours?</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-yellow-500 mx-auto mb-6 rounded-full"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <IoMdTrain className="text-5xl text-red-600" />,
                title: "Local Experts",
              ...
              {
                icon: <SiYourtraveldottv className="text-5xl text-amber-600" />,
              ...
              {
                icon: <FaHome className="text-5xl text-red-500" />,
      ...
      {showBookingForm && selectedPackage && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="sticky top-0 bg-gradient-to-r from-red-600 to-yellow-600 p-4 flex justify-between items-center z-10">
              ...
              {formSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <motion.button 
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`bg-gradient-to-r from-red-600 to-yellow-600 text-white px-8 py-3 rounded-lg font-medium shadow-lg`}
                    onClick={() => setShowBookingForm(false)}
                  >
                    Close
                  </motion.button>
                ...
                <>
                  ...
                  <div className="mb-6 p-4 bg-gradient-to-r from-red-50 to-yellow-50 rounded-lg border border-red-100">
                  ...
                  <form onSubmit={handleSubmit}>
                        ...
                        <div id="budget">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="economy">Economy (₹50,000 - ₹75,000)</option>
                              <option value="mid-range">Mid-Range (₹75,000 - ₹1,00,000)</option>
                              <option value="premium">Premium (₹1,00,000 - ₹1,50,000)</option>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          ...
                          />
                          <label htmlFor="heritage" className="ml-2 block text-sm text-gray-700">
                            Heritage Sites
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded"
                          />
                          <label htmlFor="nature" className="ml-2 block text-sm text-gray-700">
                            Nature Experiences
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded"
                          />
                          <label htmlFor="foodTour" className="ml-2 block text-sm text-gray-700">
                            Food Tour
                          </label>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <motion.button
                        ...
                        className={`w-full bg-gradient-to-r from-red-600 to-yellow-600 hover:from-red-700 hover:to-yellow-700 text-white py-3 rounded-lg font-bold transition-all duration-200 shadow-lg ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
