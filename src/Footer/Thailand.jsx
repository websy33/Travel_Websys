...
import { 
  FaStar, FaHeart, FaChevronDown, FaUmbrellaBeach, FaTimes, 
  FaPlus, FaMinus, FaPhone, FaEnvelope, FaMapMarkerAlt, FaUser,
  FaWallet, FaHotel, FaUtensils, FaCalendarAlt, FaCamera, FaSpa,
  FaExclamationCircle
} from 'react-icons/fa';
import { GiElephant, GiStonePath, GiIsland, GiShoppingBag, GiFlowerPot } from 'react-icons/gi';
import { MdSpa, MdFamilyRestroom, MdLocalDining } from 'react-icons/md';
...
const Thailand = () => {
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Thailand Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Thailand",
          booking_reference: `THAILAND-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      pinkFeature: "Pink sunset cocktail reception at rooftop bar"
    },
    {
      id: 2,
      ...
      pinkFeature: "Pink orchid lei welcome ceremony"
    },
    {
      id: 3,
      ...
      pinkFeature: "Pink-themed family photoshoot with traditional costumes"
    },
    {
      id: 4,
      ...
      pinkFeature: "Pink rose petal decoration and champagne"
    },
    {
      id: 5,
      title: "Island Hopping Explorer",
      ...
      type: "island",
      highlights: [
        "Multiple island visits including Phi Phi",
        "Snorkeling in crystal clear waters",
        "Beachfront accommodation",
        "Seafood barbecue dinners",
        "Sunset viewing points",
        "Marine life exploration"
      ],
      icon: <GiIsland className="text-2xl text-teal-500" />,
      pinkFeature: "Pink coral reef snorkeling experience"
    },
    {
      id: 6,
      ...
      type: "cultural",
      highlights: [
        "Ancient temple tours in Bangkok",
        "Historical park visits in Ayutthaya",
        "Traditional Thai dance shows",
        "Local market experiences",
        "Monk blessing ceremony",
        "Cultural workshops"
      ],
      icon: <GiStonePath className="text-2xl text-amber-600" />,
      pinkFeature: "Pink silk weaving demonstration and souvenir"
    }
  ];
  ...
  const specialFeatures = [
    ...
    { icon: <FaCamera className="text-xl" />, text: "Island Photography" },
    { icon: <MdLocalDining className="text-xl" />, text: "Thai Cuisine" },
    { icon: <GiShoppingBag className="text-xl" />, text: "Night Markets" },
    { icon: <FaSpa className="text-xl" />, text: "Luxury Spas" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-orange-50">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <GiFlowerPot className="mr-2 text-orange-300" /> LAND OF SMILES
            </div>
          </motion.div>
          ...
          >
            <div className="animate-bounce text-orange-200 text-2xl">
              <FaChevronDown />
            </div>
          </motion.div>
        </div>
      ...
      <div className="bg-gradient-to-r from-orange-500 to-blue-600 py-4 px-6 text-white">
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Thailand Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the magic of Thailand with our specially curated packages featuring exclusive pink-themed experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'luxury', 'adventure', 'family', 'honeymoon', 'island', 'cultural'].map((tab) => (
            <motion.button
              key={tab}
                ...
                >
                  ...
                  <div className="p-6">
                        ...
                        >
                          <div className="pt-4 border-t border-orange-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <GiFlowerPot className="text-orange-500 mr-2" /> Package Highlights:
                            </h4>
                            ...
                            <div className="bg-orange-50 rounded-lg p-4 mb-4 border border-orange-100">
                              ...
                              <p className="mt-1 text-orange-600">{pkg.pinkFeature}</p>
                            </div>
                          </div>
                        </motion.div>
                      )}
                    ...
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="w-full mt-4 bg-gradient-to-r from-orange-500 to-blue-600 hover:from-orange-600 hover:to-blue-700 text-white py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all"
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Thailand itinerary</p>
            <button className="bg-gradient-to-r from-orange-500 to-blue-600 text-white px-8 py-3 rounded-full font-medium hover:from-orange-600 hover:to-blue-700 transition-all shadow-lg">
              Enquire About Thailand Tours
            </button>
          </motion.div>
        )}
      </div>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-50 to-orange-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Thailand Experts",
                description: "Deep local knowledge of Thai culture and destinations",
                icon: "🧔",
                bg: "bg-orange-100"
              },
              {
              ...
              },
              {
                ...
                description: "Authentic Thai experiences beyond tourist spots",
                icon: "🎭",
                bg: "bg-purple-100"
              }
            ].map((feature, index) => (
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Thailand's Beauty</h2>
      ...
      {showBookingForm && selectedPackage && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="sticky top-0 bg-gradient-to-r from-orange-500 to-blue-600 p-4 flex justify-between items-center z-10">
              ...
              {formSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <motion.button 
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`bg-gradient-to-r from-orange-500 to-blue-600 text-white px-8 py-3 rounded-lg font-medium shadow-lg`}
                    onClick={() => setShowBookingForm(false)}
                  >
                    Close
                  </motion.button>
                ...
                <>
                  ...
                  <div className="mb-6 p-4 bg-gradient-to-r from-orange-50 to-blue-50 rounded-lg border border-orange-100">
                    <div className="flex justify-between items-center mb-2">
                      <h4 className="font-bold text-gray-900 text-lg">{selectedPackage.title}</h4>
                      <span className="font-bold text-orange-600 text-lg">{selectedPackage.price}</span>
                    </div>
                  ...
                  <form onSubmit={handleSubmit}>
                        ...
                        <div id="adults">
                          ...
                          <div className="relative flex items-center">
                            ...
                            <input
                              ...
                              min="1"
                              max="100"
                              className={`w-full text-center px-4 py-2 border-t border-b focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${
                        ...
                        <div>
                          ...
                          <div className="relative flex items-center">
                            ...
                            <input
                              ...
                              min="0"
                              max="20"
                              className="w-full text-center px-4 py-2 border-t border-b border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                            />
                            <button
                              type="button"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                          />
                          <label htmlFor="anniversaryCake" className="ml-2 block text-sm text-gray-700">
                            Anniversary Cake
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="honeymoonDecorations"
                            name="honeymoonDecorations"
                            checked={formData.specialRequests.honeymoonDecorations}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                          />
                          <label htmlFor="honeymoonDecorations" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                          />
                          <label htmlFor="airportTransfer" className="ml-2 block text-sm text-gray-700">
                            Airport Transfer
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="privateGuide"
                            name="privateGuide"
                            checked={formData.specialRequests.privateGuide}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                          />
                          <label htmlFor="privateGuide" className="ml-2 block text-sm text-gray-700">
                            Private Guide
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            checked={formData.specialRequests.vegetarianMeals}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                          />
                          <label htmlFor="vegetarianMeals" className="ml-2 block text-sm text-gray-700">
                            Vegetarian Meals
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="specialDietary"
                            name="specialDietary"
                            checked={formData.specialRequests.specialDietary}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                          />
                          <label htmlFor="specialDietary" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="islandHopping"
                            name="islandHopping"
                            checked={formData.specialRequests.islandHopping}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                          />
                          <label htmlFor="islandHopping" className="ml-2 block text-sm text-gray-700">
                            Island Hopping
                          </label>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <motion.button
                        ...
                        className={`w-full bg-gradient-to-r from-orange-500 to-blue-600 hover:from-orange-600 hover:to-blue-700 text-white py-3 rounded-lg font-bold transition-all duration-200 shadow-lg ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
