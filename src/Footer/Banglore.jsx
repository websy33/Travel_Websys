...
import { 
  ...
  FaUser, FaWallet, FaHotel, FaHeart, FaCamera, FaSpa,
  FaExclamationCircle
} from 'react-icons/fa';
import { GiPlantRoots, GiTeapot, GiShoppingBag, GiFlowerPot } from 'react-icons/gi';
import { MdOutlineHiking, MdLandscape, MdFamilyRestroom, MdTempleHindu, MdLocalDining } from 'react-icons/md';
...
const Bangalore = () => {
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Bangalore Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Bangalore-Mysore-Ooty",
          booking_reference: `BANGALORE-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      pinkFeature: "Special pink-themed cultural evening with traditional dance"
    },
    {
      id: 2,
      ...
      highlights: [
        ...
        "Heritage walk in old Bangalore"
      ],
      icon: <MdTempleHindu className="text-2xl text-amber-700" />,
      pinkFeature: "Pink silk saree shopping experience in Mysore"
    },
    {
      id: 3,
      ...
      pinkFeature: "Pink sunset photography at Ooty Lake"
    },
    {
      id: 4,
      ...
      pinkFeature: "Pink champagne welcome at luxury resorts"
    },
    {
      id: 5,
      ...
      price: "₹27,999",
      rating: 4.7,
      image: "/images/Banglore5.jpg",
      type: "family",
      highlights: [
        "Kid-friendly activities and attractions",
        "Toy train experience for children",
        "Visit to Mysore Zoo",
        "Family boating in Ooty",
        "Interactive cultural experiences",
        "Child-friendly accommodations"
      ],
      icon: <MdFamilyRestroom className="text-2xl text-blue-500" />,
      pinkFeature: "Pink-themed family photoshoot in botanical gardens"
    },
    {
      id: 6,
      ...
      pinkFeature: "Pink rose petal decoration in rooms"
    }
  ];
  ...
  // Special Features for Bangalore
  const specialFeatures = [
    { icon: <FaHeart className="text-xl" />, text: "Romantic Getaways" },
    { icon: <FaCamera className="text-xl" />, text: "Instagram Spots" },
    { icon: <MdLocalDining className="text-xl" />, text: "South Indian Cuisine" },
    { icon: <GiShoppingBag className="text-xl" />, text: "Silk & Handicrafts" },
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-green-50">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <GiFlowerPot className="mr-2 text-green-300" /> GARDEN CITY & BEYOND
            </div>
          </motion.div>
          ...
          >
            Bangalore <span className="text-green-200">Mysore Ooty</span>
          </motion.h1>
          ...
          >
            From bustling IT hubs to royal palaces and misty hill stations in South India's golden triangle
          </motion.p>
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Bangalore Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the best of South India with our specially curated packages featuring exclusive pink-themed experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'heritage', 'nature', 'luxury', 'family', 'romantic'].map((tab) => (
            <motion.button
              key={tab}
                        ...
                        >
                          <div className="pt-4 border-t border-green-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <GiFlowerPot className="text-green-500 mr-2" /> Package Highlights:
                            </h4>
                            ...
                            <div className="bg-green-50 rounded-lg p-4 mb-4 border border-green-100">
                              ...
                              <p className="mt-1 text-green-600">{pkg.pinkFeature}</p>
                            </div>
                          </div>
                        </motion.div>
                      )}
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Bangalore-Mysore-Ooty itinerary</p>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-50 to-green-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "South India Experts",
                description: "Deep local knowledge of Karnataka and Tamil Nadu",
                icon: "🧔",
                bg: "bg-green-100"
              },
              {
                title: "Toy Train Specialists",
                description: "Guaranteed bookings on the Nilgiri Mountain Railway",
                icon: "🚂",
                bg: "bg-blue-100"
              },
              {
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Bangalore-Mysore-Ooty</h2>
