...
import { 
  ...
  FaUsers, FaChild, FaHotel, FaUtensils, FaWallet, FaPlus, FaMinus, FaExclamationCircle, FaUmbrellaBeach,
  FaWater, FaTree
} from 'react-icons/fa';
import { GiMoneyStack, GiIsland, GiDolphin } from 'react-icons/gi';
import { MdFamilyRestroom, MdRestaurant, MdOutlineHiking } from 'react-icons/md';
...
const Mauritius = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    package: '',
    specialRequests: {
      beachFrontVilla: false,
      scubaDiving: false,
      spaTreatments: false,
      hikingTours: false,
      dolphinWatching: false,
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Mauritius Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Mauritius",
          booking_reference: `MAU-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      highlights: [
        ...
        "Sunset catamaran cruise with cocktails",
        "Spa wellness package with massage",
        "Water sports equipment included",
        "Private transfer from airport"
      ],
      icon: <FaUmbrellaBeach className="text-2xl text-blue-500" />,
      specialFeature: "Private beach dinner under the stars"
    },
    {
      id: 2,
      ...
      type: "adventure",
      highlights: [
        "Visit to Île aux Cerfs with lunch",
        "Snorkeling at Blue Bay Marine Park",
        "Speedboat tour to Northern Isles",
        "Underwater waterfall viewing experience",
        "Traditional Sega dance show dinner",
        "Glass bottom boat coral viewing",
        "Local market shopping tour"
      ],
      icon: <IoBoat className="text-2xl text-blue-500" />,
      specialFeature: "Private speedboat with experienced captain"
    },
    {
      id: 3,
      ...
      highlights: [
        ...
        "Romantic beach candlelight dinner",
        "Champagne sunset cruise",
        "Personalized butler service",
        "Flower petal room decoration",
        "Private photo shoot session"
      ],
      icon: <FaHeart className="text-2xl text-blue-500" />,
      specialFeature: "Honeymoon suite with ocean view and jacuzzi"
    },
    {
      id: 4,
      ...
      highlights: [
        ...
        "Casela Nature Park visit with safari",
        "Glass bottom boat ride for all ages",
        "Family cooking class with local chef",
        "Beach games and water sports",
        "Family-friendly accommodation"
      ],
      icon: <MdFamilyRestroom className="text-2xl text-blue-500" />,
      specialFeature: "Private family beach picnic setup"
    },
    {
      id: 5,
      ...
      price: "₹97,999",
      rating: 4.8,
      image: "/images/MAU5.jpeg",
      type: "luxury",
      highlights: [
        "Luxury all-inclusive resort stay",
        "Premium drinks and cocktails included",
        "Fine dining at multiple restaurants",
        "Private beach cabana service",
        "Unlimited water sports activities",
        "Evening entertainment shows",
        "24-hour room service"
      ],
      icon: <GiMoneyStack className="text-2xl text-blue-500" />,
      specialFeature: "Personal concierge service throughout stay"
    },
    {
      id: 6,
      title: "Nature & Wildlife Explorer",
      duration: "6 Days / 5 Nights",
      price: "₹71,999",
      rating: 4.7,
      image: "/images/MAU6.jpeg",
      type: "adventure",
      highlights: [
        "Black River Gorges National Park hike",
        "Seven Colored Earth geological site",
        "Chamarel Waterfall visit",
        "Vanilla and tea plantation tour",
        "Bird watching in native forests",
        "Botanical garden exploration",
        "Eco-friendly accommodation"
      ],
      icon: <FaTree className="text-2xl text-blue-500" />,
      specialFeature: "Private nature guide for hiking tours"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <GiIsland className="mr-2 text-blue-300" /> ISLAND PARADISE
            </div>
          </motion.div>
          ...
          >
            Mauritius <span className="text-blue-200">Tropical</span> Escape
          </motion.h1>
          ...
          >
            Where turquoise waters meet powder-white sands in the heart of the Indian Ocean
          </motion.p>
      ...
      <div className="bg-gradient-to-r from-blue-500 to-cyan-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <GiIsland className="text-xl" />, text: "Pristine Beaches" },
              { icon: <FaWater className="text-xl" />, text: "Crystal Waters" },
              { icon: <FaUmbrellaBeach className="text-xl" />, text: "Luxury Resorts" },
              { icon: <GiDolphin className="text-xl" />, text: "Marine Life" },
              { icon: <FaSpa className="text-xl" />, text: "Wellness Retreats" }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Mauritius Vacation Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover the magic of Mauritius with our specially curated packages featuring exclusive island experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'adventure', 'romantic', 'family', 'luxury'].map((tab) => (
            <motion.button
              key={tab}
                ...
                >
                  ...
                  <div className="p-6">
                        ...
                        >
                          <div className="pt-4 border-t border-blue-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <GiIsland className="text-blue-500 mr-2" /> Package Highlights:
                            </h4>
                    ...
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="w-full mt-4 bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all"
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Mauritius itinerary</p>
            <button className="bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-8 py-3 rounded-full font-medium hover:from-blue-600 hover:to-cyan-700 transition-all shadow-lg">
              Enquire About Mauritius Tours
            </button>
          </motion.div>
        )}
      </div>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-50 to-cyan-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Why Book With Us</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Mauritius Island Experts",
                description: "Our team has extensive knowledge of Mauritius",
                icon: "🏝️",
                bg: "bg-blue-100"
              },
              {
                title: "Best Resort Partners",
                description: "Premium beachfront resorts with verified quality",
                icon: "🏨",
                bg: "bg-cyan-100"
              },
              {
                title: "Island Experience",
                description: "From water sports to cultural tours - we handle it all",
                icon: "🤿",
                bg: "bg-blue-100"
              }
            ].map((feature, index) => (
      ...
      {/* Mauritius Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Discover Mauritius' Beauty</h2>
      ...
      {showBookingForm && selectedPackage && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="sticky top-0 bg-gradient-to-r from-blue-500 to-cyan-600 p-4 flex justify-between items-center z-10">
              ...
              {formSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <motion.button 
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-8 py-3 rounded-lg font-medium shadow-lg`}
                    onClick={() => setShowBookingForm(false)}
                  >
                    Close
                  </motion.button>
                  ...
                  <form onSubmit={handleSubmit}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="beachFrontVilla"
                            name="beachFrontVilla"
                            checked={formData.specialRequests.beachFrontVilla}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="beachFrontVilla" className="ml-2 block text-sm text-gray-700">
                            Beach Front Villa
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="scubaDiving" className="ml-2 block text-sm text-gray-700">
                            Scuba Diving
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="spaTreatments"
                            name="spaTreatments"
                            checked={formData.specialRequests.spaTreatments}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="spaTreatments" className="ml-2 block text-sm text-gray-700">
                            Spa Treatments
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="dolphinWatching"
                            name="dolphinWatching"
                            checked={formData.specialRequests.dolphinWatching}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="dolphinWatching" className="ml-2 block text-sm text-gray-700">
                            Dolphin Watching
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="privateChef"
                            name="privateChef"
                            checked={formData.specialRequests.privateChef}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="privateChef" className="ml-2 block text-sm text-gray-700">
                            Private Chef
                          </label>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <motion.button
                        ...
                        className={`w-full bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white py-3 rounded-lg font-bold transition-all duration-200 shadow-lg ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
