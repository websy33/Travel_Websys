...
import { 
  ...
  FaBuilding, FaShoppingBag, FaCity, FaShip
} from 'react-icons/fa';
import { GiMoneyStack, GiNightSky, GiFlowerPot } from 'react-icons/gi';
import { MdCasino, MdOutlineHiking, MdFamilyRestroom, MdLocalDining } from 'react-icons/md';
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Hong Kong & Macao Tour Package - ${selectedPackage.title}`,
  ...
  const packages = [
    {
      ...
      specialFeature: "VIP access to Symphony of Lights viewing platform"
    },
    {
      id: 2,
      ...
      specialFeature: "Private yacht tour of Victoria Harbour"
    },
    {
      id: 3,
      ...
      specialFeature: "Disney character meet-and-greet experience"
    },
    {
      id: 4,
      ...
      specialFeature: "Private guided heritage walk with local historian"
    },
    {
      id: 5,
      ...
      price: "₹49,999",
      rating: 4.7,
      image: "/images/Hong5.jpeg",
      type: "shopping",
      highlights: [
        "Luxury shopping at IFC Mall",
        "Causeway Bay shopping district",
        "Lan Kwai Fong nightlife experience",
        "Macao casino entertainment",
        "Duty-free shopping",
        "Night market exploration"
      ],
      icon: <FaShoppingBag className="text-2xl text-purple-600" />,
      specialFeature: "Personal shopping assistant and style consultant"
    },
    {
      id: 6,
      ...
      price: "₹79,999",
      rating: 4.9,
      image: "/images/Hong6.jpeg",
      type: "romantic",
      highlights: [
        "Private Victoria Harbour cruise",
        "Romantic dinner at The Peak",
        "Couple spa treatments",
        "Macao lighthouse sunset views",
        "Champagne breakfast in bed",
        "Professional couple photoshoot"
      ],
      icon: <FaHeart className="text-2xl text-purple-600" />,
      specialFeature: "Private helicopter tour over Hong Kong"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-pink-50">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <FaCity className="mr-2 text-purple-300" /> EAST MEETS WEST
            </div>
          </motion.div>
          ...
          >
            Hong Kong <span className="text-pink-200">&</span> Macao
          </motion.h1>
          ...
          >
            Where dazzling skylines meet rich cultural heritage in Asia's world city
          </motion.p>
      ...
      <div className="bg-gradient-to-r from-purple-500 to-pink-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <FaShoppingBag className="text-xl" />, text: "Shopping Paradise" },
              { icon: <MdLocalDining className="text-xl" />, text: "Michelin Dining" },
              { icon: <GiNightSky className="text-xl" />, text: "Vibrant Nightlife" },
              { icon: <FaBuilding className="text-xl" />, text: "Cultural Heritage" },
              { icon: <FaSpa className="text-xl" />, text: "Luxury Experiences" }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Hong Kong & Macao Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the best of both worlds with our carefully curated packages featuring exclusive urban experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'luxury', 'family', 'cultural', 'shopping', 'romantic'].map((tab) => (
            <motion.button
              key={tab}
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Hong Kong & Macao itinerary</p>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-50 to-pink-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Local Hong Kong Experts",
                description: "Our team has extensive experience in Hong Kong tourism",
                icon: "🏙️",
                bg: "bg-purple-100"
              },
              {
                title: "Best Hotel Partners",
                description: "Premium accommodations with verified quality",
                icon: "🏨",
                bg: "bg-pink-100"
              },
              {
                title: "Hassle-Free Experience",
                description: "From visas to transport - we handle it all",
                icon: "✨",
                bg: "bg-purple-100"
              }
            ].map((feature, index) => (
      ...
      {/* Hong Kong Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Hong Kong & Macao's Beauty</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {hongKongImages.map((image, index) => (
              <motion.div
                key={index}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          <input
                            ...
                            checked={formData.specialRequests.shoppingExperience}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="shoppingExperience" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="fineDining"
                            name="fineDining"
                            checked={formData.specialRequests.fineDining}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="fineDining" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="nightlife" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="heritageSites"
                            name="heritageSites"
                            checked={formData.specialRequests.heritageSites}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="heritageSites" className="ml-2 block text-sm text-gray-700">
                            Heritage Sites Tour
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="disneylandPriority"
                            name="disneylandPriority"
                            checked={formData.specialRequests.disneylandPriority}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="disneylandPriority" className="ml-2 block text-sm text-gray-700">
                            Disneyland Priority Access
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="macaoCasino"
                            name="macaoCasino"
                            checked={formData.specialRequests.macaoCasino}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="macaoCasino" className="ml-2 block text-sm text-gray-700">
                            Macao Casino Experience
                          </label>
                        </div>
