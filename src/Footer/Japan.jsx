...
import { 
  ...
  FaMountain, FaTree, FaLeaf, FaCity, FaBuilding
} from 'react-icons/fa';
import { GiMoneyStack, GiFlowerPot } from 'react-icons/gi';
import { MdTempleBuddhist, MdFamilyRestroom, MdLocalDining } from 'react-icons/md';
...
const Japan = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    package: '',
    specialRequests: {
      cherryBlossomViewing: false,
      traditionalRyokan: false,
      bulletTrainExperience: false,
      teaCeremony: false,
      sushiMakingClass: false,
      onsenExperience: false,
      photographySession: false,
      culturalWorkshops: false,
      other: ''
    },
    message: ''
  });
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Japan Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Japan",
          booking_reference: `JAPAN-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      highlights: [
        ...
        "Historic temples and shrines exploration"
      ],
      icon: <FaStar className="text-2xl text-purple-600" />,
      specialFeature: "Private guided tour of Fushimi Inari Shrine at sunrise"
    },
    {
      id: 2,
      ...
      icon: <GiMoneyStack className="text-2xl text-purple-600" />,
      specialFeature: "Private helicopter tour over Mount Fuji"
    },
    {
      id: 3,
      ...
      icon: <MdFamilyRestroom className="text-2xl text-purple-600" />,
      specialFeature: "Private character meet-and-greet at Disney parks"
    },
    {
      id: 4,
      ...
      icon: <MdTempleBuddhist className="text-2xl text-purple-600" />,
      specialFeature: "Private audience with temple head priest"
    },
    {
      id: 5,
      ...
      price: "₹1,89,999",
      rating: 4.8,
      image: "/images/Japan5.jpeg",
      type: "wellness",
      highlights: [
        "Onsen hot spring experiences",
        "Forest bathing in ancient forests",
        "Traditional Japanese spa treatments",
        "Mount Fuji climbing expedition",
        "Zen garden meditation sessions",
        "Organic farm-to-table dining"
      ],
      icon: <FaLeaf className="text-2xl text-purple-600" />,
      specialFeature: "Private onsen experience with mountain views"
    },
    {
      id: 6,
      ...
      price: "₹1,69,999",
      rating: 4.9,
      image: "/images/Japan6.jpeg",
      type: "seasonal",
      highlights: [
        "Cherry blossom viewing parties",
        "Photography sessions in sakura gardens",
        "Seasonal kaiseki meals",
        "Night illumination events",
        "Sakura-themed cultural activities",
        "Exclusive hanami locations"
      ],
      icon: <GiFlowerPot className="text-2xl text-purple-600" />,
      specialFeature: "Private evening hanami with geisha performance"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-pink-50">
      ...
      <div className="relative h-screen max-h-[800px] overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-purple-900/60 to-pink-700/50"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <MdTempleBuddhist className="mr-2 text-purple-300" /> LAND OF THE RISING SUN
            </div>
          </motion.div>
          ...
          >
            Japan <span className="text-pink-200">Journey</span>
          </motion.h1>
          ...
          >
            Where ancient traditions meet cutting-edge modernity in perfect harmony
          </motion.p>
          ...
          <motion.div
            ...
            className="text-purple-200 text-5xl animate-pulse"
          >
            <MdTempleBuddhist />
          </motion.div>
      ...
      <div className="bg-gradient-to-r from-purple-500 to-pink-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <MdTempleBuddhist className="text-xl" />, text: "Ancient Temples" },
              { icon: <FaMountain className="text-xl" />, text: "Mount Fuji Views" },
              { icon: <FaLeaf className="text-xl" />, text: "Cherry Blossoms" },
              { icon: <FaCity className="text-xl" />, text: "Modern Cities" },
              { icon: <FaUtensils className="text-xl" />, text: "Gourmet Cuisine" }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Japan Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the best of Japan with our carefully curated packages featuring exclusive cultural experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'luxury', 'family', 'cultural', 'wellness', 'seasonal'].map((tab) => (
            <motion.button
              key={tab}
          ...
          {filteredPackages.map((pkg) => {
            ...
            return (
              ...
              >
                {/* Package Card */}
                <motion.div 
                  className={`bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 ${isExpanded ? 'ring-2 ring-purple-500' : ''}`}
                  whileHover={{ y: -5 }}
                >
                  ...
                  <div className="relative h-60 overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                      ...
                      <div className="flex justify-between items-center mt-2">
                        <span className="bg-purple-600 text-white text-xs px-3 py-1 rounded-full">{pkg.price}</span>
                  ...
                  <div className="p-6">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <button
                        ...
                        className="text-purple-600 font-medium hover:text-purple-700 transition-colors flex items-center text-sm"
                      >
                        {isExpanded ? 'Show Less' : 'View Details'} 
                        <FaChevronDown className={`ml-2 text-purple-500 transition-transform ${isExpanded ? 'rotate-180' : ''}`} />
                      </button>
                    </div>
                        ...
                        >
                          <div className="pt-4 border-t border-purple-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <FaStar className="text-purple-500 mr-2" /> Package Highlights:
                            </h4>
                            ...
                            <div className="bg-purple-50 rounded-lg p-4 mb-4 border border-purple-100">
                              ...
                              <p className="mt-1 text-purple-600">{pkg.specialFeature}</p>
                            </div>
                          </div>
                        </motion.div>
                      )}
                    ...
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="w-full mt-4 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all"
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Japan itinerary</p>
            <button className="bg-gradient-to-r from-purple-500 to-pink-600 text-white px-8 py-3 rounded-full font-medium hover:from-purple-600 hover:to-pink-700 transition-all shadow-lg">
              Enquire About Japan Tours
            </button>
          </motion.div>
        )}
      </div>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-50 to-pink-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Why Book With Us</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Japan Travel Experts",
                description: "Our team has extensive experience in Japanese tourism",
                icon: "🗾",
                bg: "bg-purple-100"
              },
              {
                title: "Authentic Experiences",
                description: "Genuine cultural activities with local experts",
                icon: "🎎",
                bg: "bg-pink-100"
              },
              {
                title: "Seamless Planning",
                description: "From JR Pass to accommodation - we handle it all",
                icon: "🚄",
                bg: "bg-purple-100"
              }
            ].map((feature, index) => (
      ...
      {/* Japan Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Japan's Beauty</h2>
      ...
      {showBookingForm && selectedPackage && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="sticky top-0 bg-gradient-to-r from-purple-500 to-pink-600 p-4 flex justify-between items-center z-10">
              ...
              {formSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <motion.button 
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`bg-gradient-to-r from-purple-500 to-pink-600 text-white px-8 py-3 rounded-lg font-medium shadow-lg`}
                    onClick={() => setShowBookingForm(false)}
                  >
                    Close
                  </motion.button>
                ...
                <>
                  ...
                  <div className="mb-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-100">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-bold text-purple-600 text-lg">{selectedPackage.price}</span>
                    </div>
                  ...
                  <form onSubmit={handleSubmit}>
                        ...
                        <div id="adults">
                          ...
                          <div className="relative flex items-center">
                            ...
                            <input
                              ...
                              min="1"
                              max="100"
                              className={`w-full text-center px-4 py-2 border-t border-b focus:ring-2 focus:ring-purple-500 focus:border-purple-500 ${
                        ...
                        <div>
                          ...
                          <div className="relative flex items-center">
                            ...
                            <input
                              ...
                              min="0"
                              max="20"
                              className="w-full text-center px-4 py-2 border-t border-b border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                            />
                            <button
                              type="button"
                        ...
                        <div id="budget">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="economy">Economy (₹1,00,000 - ₹2,00,000)</option>
                              <option value="mid-range">Mid-Range (₹2,00,000 - ₹3,50,000)</option>
                              <option value="premium">Premium (₹3,50,000 - ₹5,00,000)</option>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="cherryBlossomViewing"
                            name="cherryBlossomViewing"
                            checked={formData.specialRequests.cherryBlossomViewing}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="cherryBlossomViewing" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="traditionalRyokan"
                            name="traditionalRyokan"
                            checked={formData.specialRequests.traditionalRyokan}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="traditionalRyokan" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="bulletTrainExperience"
                            name="bulletTrainExperience"
                            checked={formData.specialRequests.bulletTrainExperience}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="bulletTrainExperience" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="teaCeremony"
                            name="teaCeremony"
                            checked={formData.specialRequests.teaCeremony}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="teaCeremony" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="sushiMakingClass"
                            name="sushiMakingClass"
                            checked={formData.specialRequests.sushiMakingClass}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="sushiMakingClass" className="ml-2 block text-sm text-gray-700">
                            Sushi Making Class
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="onsenExperience"
                            name="onsenExperience"
                            checked={formData.specialRequests.onsenExperience}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="onsenExperience" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="culturalWorkshops"
                            name="culturalWorkshops"
                            checked={formData.specialRequests.culturalWorkshops}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                          />
                          <label htmlFor="culturalWorkshops" className="ml-2 block text-sm text-gray-700">
                            Cultural Workshops
                          </label>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <motion.button
                        ...
                        className={`w-full bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white py-3 rounded-lg font-bold transition-all duration-200 shadow-lg ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
