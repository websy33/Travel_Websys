...
import { 
  ...
  FaMountain, FaChurch, FaHiking, FaWineGlassAlt
} from 'react-icons/fa';
import { GiMoneyStack, GiGrapes, GiVillage, GiFlowerPot } from 'react-icons/gi';
import { MdOutlineCastle, MdFamilyRestroom, MdLocalDining } from 'react-icons/md';
...
const Georgia = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    specialRequests: {
      wineTasting: false,
      qvevriWineMaking: false,
      hikingAdventures: false,
      culturalWorkshops: false,
      photographyTours: false,
      traditionalFeasts: false,
      monasteryVisits: false,
      villageStays: false,
      other: ''
    },
    message: ''
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Georgia Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Georgia",
          booking_reference: `GEORGIA-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      specialFeature: "Private wine tasting at 8000-year-old winery"
    },
    {
      id: 2,
      ...
      specialFeature: "Hands-on qvevri wine-making workshop"
    },
    {
      id: 3,
      ...
      icon: <FaHiking className="text-2xl text-red-600" />,
      specialFeature: "Guided trek to Gergeti Trinity Church"
    },
    {
      id: 4,
      ...
      icon: <FaChurch className="text-2xl text-red-600" />,
      specialFeature: "Private polyphonic singing performance"
    },
    {
      id: 5,
      ...
      price: "₹45,999",
      rating: 4.5,
      image: "/images/Georgia5.jpeg",
      type: "city",
      highlights: [
        "Tbilisi city exploration",
        "Sulfur bath experience",
        "Cable car to Narikala Fortress",
        "Dry Bridge Market shopping",
        "Georgian cooking class",
        "Evening city tours"
      ],
      icon: <MdOutlineCastle className="text-2xl text-red-600" />,
      specialFeature: "Private guided tour of Tbilisi's hidden gems"
    },
    {
      id: 6,
      title: "Svaneti Wilderness",
      duration: "9 Days / 8 Nights",
      price: "₹72,999",
      rating: 4.8,
      image: "/images/Georgia6.jpeg",
      type: "wilderness",
      highlights: [
        "Svaneti tower villages",
        "Ushguli - highest settlement in Europe",
        "Shkhara glacier trekking",
        "Traditional Svanetian cuisine",
        "Medieval tower stays",
        "Local guide services"
      ],
      icon: <GiVillage className="text-2xl text-red-600" />,
      specialFeature: "Stay in authentic Svanetian defensive tower"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-50 to-white">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <GiGrapes className="mr-2 text-red-300" /> CRADLE OF WINE
            </div>
          </motion.div>
          ...
          >
            Georgia <span className="text-red-200">Adventure</span>
          </motion.h1>
          ...
          >
            Where ancient wine traditions meet breathtaking Caucasus landscapes
          </motion.p>
      ...
      <div className="bg-gradient-to-r from-red-500 to-orange-500 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <GiGrapes className="text-xl" />, text: "8000-Year Wine History" },
              { icon: <FaChurch className="text-xl" />, text: "Ancient Churches" },
              { icon: <FaMountain className="text-xl" />, text: "Caucasus Peaks" },
              { icon: <GiVillage className="text-xl" />, text: "Mountain Villages" },
              { icon: <FaUtensils className="text-xl" />, text: "Georgian Cuisine" }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Georgia Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover the birthplace of wine with our carefully curated packages featuring authentic Georgian experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'wine', 'adventure', 'heritage', 'city', 'wilderness'].map((tab) => (
            <motion.button
              key={tab}
                ...
                >
                  ...
                  <div className="p-6">
                        ...
                        >
                          <div className="pt-4 border-t border-red-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <FaStar className="text-red-500 mr-2" /> Package Highlights:
                            </h4>
                    ...
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="w-full mt-4 bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all"
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Georgia itinerary</p>
            <button className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-8 py-3 rounded-full font-medium hover:from-red-600 hover:to-orange-600 transition-all shadow-lg">
              Enquire About Georgia Tours
            </button>
          </motion.div>
        )}
      </div>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-red-50 to-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Why Book With Us</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Georgia Travel Experts",
                description: "Our team has deep knowledge of Georgian culture and wine",
                icon: "🍷",
                bg: "bg-red-100"
              },
              {
              ...
              },
              {
                ...
                description: "From wine tours to mountain hikes - we handle it all",
                icon: "✨",
                bg: "bg-red-100"
              }
            ].map((feature, index) => (
      ...
      {/* Georgia Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Georgia's Beauty</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {georgiaImages.map((image, index) => (
              <motion.div
                key={index}
      ...
      {showBookingForm && selectedPackage && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="sticky top-0 bg-gradient-to-r from-red-500 to-orange-500 p-4 flex justify-between items-center z-10">
              ...
              {formSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <motion.button 
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`bg-gradient-to-r from-red-500 to-orange-500 text-white px-8 py-3 rounded-lg font-medium shadow-lg`}
                    onClick={() => setShowBookingForm(false)}
                  >
                    Close
                  </motion.button>
                  ...
                  <form onSubmit={handleSubmit}>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="guesthouse">Traditional Guesthouse</option>
                        ...
                        <div id="budget">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="premium">Premium (₹2,00,000 - ₹3,50,000)</option>
                              <option value="luxury">Luxury (₹3,50,000+)</option>
                            </select>
                            {formErrors.budget && (
                              <div className="absolute right-3 top-3 text-red-500">
                                <FaExclamationCircle />
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          ...
                          />
                          <label htmlFor="wineTasting" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="qvevriWineMaking"
                            name="qvevriWineMaking"
                            checked={formData.specialRequests.qvevriWineMaking}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded"
                          />
                          <label htmlFor="qvevriWineMaking" className="ml-2 block text-sm text-gray-700">
                            Qvevri Wine-Making
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="hikingAdventures"
                            name="hikingAdventures"
                            checked={formData.specialRequests.hikingAdventures}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded"
                          />
                          <label htmlFor="hikingAdventures" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="traditionalFeasts"
                            name="traditionalFeasts"
                            checked={formData.specialRequests.traditionalFeasts}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded"
                          />
                          <label htmlFor="traditionalFeasts" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="monasteryVisits"
                            name="monasteryVisits"
                            checked={formData.specialRequests.monasteryVisits}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded"
                          />
                          <label htmlFor="monasteryVisits" className="ml-2 block text-sm text-gray-700">
                            Monastery & Church Visits
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="villageStays"
                            name="villageStays"
                            checked={formData.specialRequests.villageStays}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded"
                          />
                          <label htmlFor="villageStays" className="ml-2 block text-sm text-gray-700">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <motion.button
                        ...
                        className={`w-full bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white py-3 rounded-lg font-bold transition-all duration-200 shadow-lg ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
