...
import { 
  ...
  FaUsers, FaChild, FaHotel, FaUtensils, FaWallet, FaPlus, FaMinus, FaExclamationCircle, FaBuilding,
  FaCity, FaMapMarkerAlt, FaShip
} from 'react-icons/fa';
import { GiOilDrum, GiMoneyStack, GiNightSky, GiFlame } from 'react-icons/gi';
import { MdOutlineHiking, MdFamilyRestroom, MdCasino } from 'react-icons/md';
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Azerbaijan Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Azerbaijan",
          booking_reference: `AZE-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      highlights: [
        ...
        "Caspian Sea waterfront walk",
        "Traditional Azerbaijani dinner"
      ],
      icon: <GiFlame className="text-2xl text-blue-500" />,
      specialFeature: "Private guided tour of UNESCO World Heritage sites"
    },
    {
      id: 2,
      ...
      highlights: [
        ...
        "Spa treatments at luxury hotel",
        "Personal chauffeur service"
      ],
      icon: <GiMoneyStack className="text-2xl text-blue-500" />,
      specialFeature: "Sunset yacht cruise on the Caspian Sea"
    },
    {
      id: 3,
      ...
      highlights: [
        ...
        "Cable car ride in Gabala"
      ],
      icon: <MdOutlineHiking className="text-2xl text-blue-500" />,
      specialFeature: "Professional adventure guide for mountain activities"
    },
    {
      id: 4,
      ...
      highlights: [
        ...
        "Ancient Zoroastrian temples",
        "Historical museums tour"
      ],
      icon: <FaBuilding className="text-2xl text-blue-500" />,
      specialFeature: "Hands-on carpet weaving workshop with master artisans"
    },
    {
      id: 5,
      ...
      price: "₹39,999",
      rating: 4.4,
      image: "/images/Azerbaijan5.jpeg",
      type: "popular",
      highlights: [
        "Comprehensive Baku city tour",
        "Flame Towers light show",
        "Baku Boulevard walk",
        "Fountains Square exploration",
        "Modern architecture tour",
        "Local markets visit",
        "Evening entertainment shows"
      ],
      icon: <FaCity className="text-2xl text-blue-500" />,
      specialFeature: "Night photography tour of illuminated Flame Towers"
    },
    {
      id: 6,
      title: "Caspian Coastal Retreat",
      duration: "6 Days / 5 Nights",
      price: "₹67,999",
      rating: 4.7,
      image: "/images/Azerbaijan6.jpeg",
      type: "luxury",
      highlights: [
        "Beachfront luxury accommodation",
        "Caspian Sea water activities",
      ...
      specialFeature: "Private beach dinner with Caspian Sea views"
    }
  ];

  const azerbaijanImages = [
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-amber-50">
      ...
      <div className="relative h-screen max-h-[800px] overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/60 to-amber-700/50"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <GiFlame className="mr-2 text-amber-300" /> LAND OF FIRE
            </div>
          </motion.div>
          ...
          >
            Azerbaijan <span className="text-amber-200">Cultural</span> Wonders
          </motion.h1>
          ...
          >
            Where ancient history meets modern architecture in the heart of the Caucasus
          </motion.p>
      ...
      <div className="bg-gradient-to-r from-blue-500 to-amber-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <GiFlame className="text-xl" />, text: "Land of Fire" },
              { icon: <FaCamera className="text-xl" />, text: "Architectural Marvels" },
              { icon: <FaUtensils className="text-xl" />, text: "Azerbaijani Cuisine" },
              { icon: <FaBuilding className="text-xl" />, text: "UNESCO Heritage" },
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Azerbaijan Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover the magic of Azerbaijan with our specially curated packages featuring exclusive cultural experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'luxury', 'adventure', 'heritage'].map((tab) => (
            <motion.button
              key={tab}
              ...
              className={`px-5 py-3 rounded-full text-sm font-medium capitalize transition-all ${activeTab === tab 
                ? 'bg-gradient-to-r from-blue-500 to-amber-600 text-white shadow-lg' 
                ...
                >
                  ...
                  <div className="p-6">
                        ...
                        >
                          <div className="pt-4 border-t border-blue-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <GiFlame className="text-blue-500 mr-2" /> Package Highlights:
                            </h4>
                    ...
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="w-full mt-4 bg-gradient-to-r from-blue-500 to-amber-600 hover:from-blue-600 hover:to-amber-700 text-white py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all"
                      onClick={() => handleBookNow(pkg)}
                    >
                      Book Azerbaijan Tour
                    </motion.button>
                  </div>
                </motion.div>
              </motion.div>
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Azerbaijan itinerary</p>
            <button className="bg-gradient-to-r from-blue-500 to-amber-600 text-white px-8 py-3 rounded-full font-medium hover:from-blue-600 hover:to-amber-700 transition-all shadow-lg">
              Enquire About Azerbaijan Tours
            </button>
          </motion.div>
        )}
      </div>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-50 to-amber-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Why Book With Us</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Local Azerbaijani Experts",
                description: "Our team has extensive knowledge of Azerbaijan's culture",
                icon: "🏛️",
                bg: "bg-blue-100"
              },
              {
                title: "Cultural Immersion",
                description: "Authentic experiences beyond typical tourist routes",
                icon: "🎭",
                bg: "bg-amber-100"
              },
              {
                title: "Hassle-Free Travel",
                description: "From visas to local transport - we handle everything",
                icon: "✨",
                bg: "bg-blue-100"
              }
            ].map((feature, index) => (
      ...
      {/* Azerbaijan Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Discover Azerbaijan's Beauty</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {azerbaijanImages.map((image, index) => (
              <motion.div
                key={index}
              ...
              >
                <img 
                  src={image} 
                  alt={`Azerbaijan scenery ${index + 1}`} 
      ...
      {showBookingForm && selectedPackage && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="sticky top-0 bg-gradient-to-r from-blue-500 to-amber-600 p-4 flex justify-between items-center z-10">
              ...
              {formSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <motion.button 
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`bg-gradient-to-r from-blue-500 to-amber-600 text-white px-8 py-3 rounded-lg font-medium shadow-lg`}
                    onClick={() => setShowBookingForm(false)}
                  >
                    Close
                  </motion.button>
                  ...
                  <form onSubmit={handleSubmit}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          <input
                            ...
                            id="shoppingFocus"
                            name="shoppingFocus"
                            checked={formData.specialRequests.shoppingFocus}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="shoppingFocus" className="ml-2 block text-sm text-gray-700">
                            Shopping Focus
                          </label>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <motion.button
                        ...
                        className={`w-full bg-gradient-to-r from-blue-500 to-amber-600 hover:from-blue-600 hover:to-amber-700 text-white py-3 rounded-lg font-bold transition-all duration-200 shadow-lg ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
                      ...
                      <motion.button
                        ...
                        className={`w-full bg-gradient-to-r from-green-500 to-green-700 hover:from-green-600 hover:to-green-800 text-white py-3 rounded-lg font-bold transition-all duration-200 shadow-lg ${isProcessing || !razorpayLoaded ? 'opacity-50 cursor-not-allowed' : ''}`}
