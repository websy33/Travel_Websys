...
import { 
  FaStar, FaCalendarAlt, FaChevronDown, FaTimes, FaPhone, FaEnvelope, 
  FaPlus, FaMinus, FaMonument, FaWater, FaUmbrellaBeach, FaUser, FaWallet, 
  FaHotel, FaUtensils, FaHeart, FaCamera, FaSpa, FaExclamationCircle
} from 'react-icons/fa';
import { GiModernCity, GiShoppingBag, GiFlowerPot } from 'react-icons/gi';
import { MdLocalDining, MdDirectionsBike } from 'react-icons/md';
...
const Egypt = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    specialRequests: {
      nileCruise: false,
      archaeologyTours: false,
      desertSafari: false,
      divingSnorkeling: false,
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Egypt Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Egypt",
          booking_reference: `EGYPT-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      specialFeature: "Private guided tour of the Great Pyramids with Egyptologist"
    },
    {
      id: 2,
      ...
      highlights: [
        ...
        "Sunset cocktail on Nile deck"
      ],
      icon: <FaWater className="text-2xl text-amber-500" />,
      specialFeature: "Exclusive dinner on board with traditional Nubian dance performance"
    },
    {
      id: 3,
      ...
      icon: <FaMonument className="text-2xl text-amber-500" />,
      specialFeature: "Hands-on hieroglyphics writing workshop"
    },
    {
      id: 4,
      ...
      specialFeature: "Private boat tour with professional snorkeling guide"
    },
    {
      id: 5,
      title: "Luxury Egypt Experience",
      duration: "10 Days / 9 Nights",
      price: "₹89,999",
      rating: 4.9,
      image: "/images/Egypt6.jpeg",
      type: "luxury",
      highlights: [
        "5-star luxury accommodations",
        "Private Egyptologist guide",
        "VIP access to archaeological sites",
        "Luxury Nile cruise suite",
        "Fine dining experiences",
        "Personalized shopping service"
      ],
      icon: <GiModernCity className="text-2xl text-amber-500" />,
      specialFeature: "Private sunrise viewing at the Great Pyramids"
    },
    {
      id: 6,
      title: "Family Egypt Adventure",
      duration: "8 Days / 7 Nights",
      price: "₹48,999",
      rating: 4.7,
      image: "/images/Egypt7.jpeg",
      type: "family",
      highlights: [
        "Kid-friendly pyramid tours",
      ...
      icon: <FaUmbrellaBeach className="text-2xl text-amber-500" />,
      specialFeature: "Special children's archaeology workshop"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
      ...
      <div className="relative h-screen max-h-[800px] overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-amber-900/60 to-yellow-700/50"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <FaMonument className="mr-2 text-amber-300" /> LAND OF PHARAOHS
            </div>
          </motion.div>
          ...
          >
            Egypt <span className="text-amber-200">Exploration</span>
          </motion.h1>
          ...
          >
            Where ancient wonders meet timeless beauty in the cradle of civilization
          </motion.p>
      ...
      <div className="bg-gradient-to-r from-amber-500 to-yellow-600 py-4 px-6 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              { icon: <FaMonument className="text-xl" />, text: "Ancient Wonders" },
              { icon: <FaCamera className="text-xl" />, text: "Historic Sites" },
              { icon: <MdLocalDining className="text-xl" />, text: "Egyptian Cuisine" },
              { icon: <GiShoppingBag className="text-xl" />, text: "Local Markets" },
              { icon: <FaSpa className="text-xl" />, text: "Nile Cruises" }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Egypt Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the magic of ancient Egypt with our specially curated packages featuring exclusive archaeological experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'cruise', 'cultural', 'beach', 'luxury', 'family'].map((tab) => (
            <motion.button
              key={tab}
                ...
                >
                  ...
                  <div className="p-6">
                        ...
                        >
                          <div className="pt-4 border-t border-amber-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <FaMonument className="text-amber-500 mr-2" /> Package Highlights:
                            </h4>
                    ...
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="w-full mt-4 bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700 text-white py-3 rounded-lg font-medium shadow-md hover:shadow-lg transition-all"
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Egypt itinerary</p>
            <button className="bg-gradient-to-r from-amber-500 to-yellow-600 text-white px-8 py-3 rounded-full font-medium hover:from-amber-600 hover:to-yellow-700 transition-all shadow-lg">
              Enquire About Egypt Tours
            </button>
          </motion.div>
        )}
      </div>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-amber-50 to-yellow-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Why Book With Us</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Certified Egyptologists",
                description: "Our guides have deep knowledge of ancient Egyptian history",
                icon: "🧔",
                bg: "bg-amber-100"
              },
              {
                title: "Premium Nile Cruises",
                description: "Luxury ships with expert-guided shore excursions",
                icon: "🚢",
                bg: "bg-yellow-100"
              },
              {
                title: "Hassle-Free Experience",
                description: "From visas to internal transport - we handle it all",
                icon: "✨",
                bg: "bg-orange-100"
              }
            ].map((feature, index) => (
      ...
      {/* Egypt Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Egypt's Beauty</h2>
      ...
      {showBookingForm && selectedPackage && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="sticky top-0 bg-gradient-to-r from-amber-500 to-yellow-600 p-4 flex justify-between items-center z-10">
              ...
              {formSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <motion.button 
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`bg-gradient-to-r from-amber-500 to-yellow-600 text-white px-8 py-3 rounded-lg font-medium shadow-lg`}
                    onClick={() => setShowBookingForm(false)}
                  >
                    Close
                  </motion.button>
                  ...
                  <form onSubmit={handleSubmit}>
                        ...
                        <div id="adults">
                          ...
                          <div className="relative flex items-center">
                            ...
                            <input
                              ...
                              min="1"
                              max="100"
                              className={`w-full text-center px-4 py-2 border-t border-b focus:ring-2 focus:ring-amber-500 focus:border-amber-500 ${
                        ...
                        <div>
                          ...
                          <div className="relative flex items-center">
                            ...
                            <input
                              ...
                              min="0"
                              max="20"
                              className="w-full text-center px-4 py-2 border-t border-b border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                            />
                            <button
                              type="button"
                        ...
                        <div id="budget">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="economy">Economy (₹40,000 - ₹60,000)</option>
                              <option value="mid-range">Mid-Range (₹60,000 - ₹90,000)</option>
                              <option value="premium">Premium (₹90,000 - ₹1,50,000)</option>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          ...
                          />
                          <label htmlFor="nileCruise" className="ml-2 block text-sm text-gray-700">
                            Nile Cruise
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            checked={formData.specialRequests.archaeologyTours}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 rounded"
                          />
                          <label htmlFor="archaeologyTours" className="ml-2 block text-sm text-gray-700">
                            Archaeology Tours
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="desertSafari"
                            name="desertSafari"
                            checked={formData.specialRequests.desertSafari}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 rounded"
                          />
                          <label htmlFor="desertSafari" className="ml-2 block text-sm text-gray-700">
                            Desert Safari
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="divingSnorkeling"
                            name="divingSnorkeling"
                            checked={formData.specialRequests.divingSnorkeling}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 rounded"
                          />
                          <label htmlFor="divingSnorkeling" className="ml-2 block text-sm text-gray-700">
                            Diving/Snorkeling
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id="luxuryAccommodation"
                            name="luxuryAccommodation"
                            checked={formData.specialRequests.luxuryAccommodation}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 rounded"
                          />
                          <label htmlFor="luxuryAccommodation" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            id="familyFriendly"
                            name="familyFriendly"
                            checked={formData.specialRequests.familyFriendly}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-amber-600 focus:ring-amber-500 border-gray-300 rounded"
                          />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <motion.button
                        ...
                        className={`w-full bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700 text-white py-3 rounded-lg font-bold transition-all duration-200 shadow-lg ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
                      >
