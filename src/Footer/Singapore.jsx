...
const Singapore = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    specialRequests: {
      ...
      cultural: false,
      shopping: false,
      universalStudios: false,
      gentingHighlands: false,
      privateGuide: false,
      other: ''
    },
    message: ''
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        currency: currency,
        name: "Traveligo",
        description: `Singapore & Malaysia Tour Package - ${selectedPackage.title}`,
        ...
        notes: {
          ...
          destination: "Singapore & Malaysia",
          booking_reference: `SG-MY-${Date.now()}`,
  ...
  const packages = [
    {
      ...
      specialFeature: "Exclusive night tour of Marina Bay Sands light show"
    },
    {
      id: 2,
      ...
      specialFeature: "Private yacht cruise around Singapore harbor"
    },
    {
      id: 3,
      ...
      specialFeature: "Family photo session at iconic locations"
    },
    {
      id: 4,
      ...
      specialFeature: "Private island picnic on secluded beach"
    },
    {
      id: 5,
      ...
      price: "₹65,999",
      rating: 4.7,
      image: "/images/Singapore5.jpeg",
      type: "cultural",
      highlights: [
        "Little India and Chinatown tours",
        "Traditional Malay village visit",
        "Batu Caves exploration",
        "Heritage walks in Penang",
        "Traditional craft workshops",
        "Cultural performances",
        "Local cuisine tasting"
      ],
      icon: <MdTempleHindu className="text-2xl text-orange-500" />,
      specialFeature: "Private meeting with local cultural experts"
    },
    {
      id: 6,
      ...
      highlights: [
        ...
        "Nature reserves exploration",
        "Wildlife spotting tours",
        "Adventure parks visits",
        "Eco-tourism experiences"
      ],
      icon: <FaTree className="text-2xl text-green-500" />,
      specialFeature: "Guided night jungle walk with naturalist"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50">
      ...
      <div className="relative h-screen max-h-[800px] overflow-hidden">
        <div className="absolute inset-0">
          <img 
            ...
            alt="Singapore Malaysia Skyline" 
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-semibold py-2 px-6 rounded-full mb-6 border border-white/30">
              <GiModernCity className="mr-2 text-purple-300" /> DUAL COUNTRY ADVENTURE
            </div>
          </motion.div>
          ...
          >
            Singapore <span className="text-purple-200">&</span> Malaysia
          </motion.h1>
          ...
          >
            Where modern marvels meet tropical paradise in Southeast Asia's most dynamic destinations
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            {[
              ...
              { icon: <MdOutlineBeachAccess className="text-xl" />, text: "Tropical Islands" },
              { icon: <MdTempleHindu className="text-xl" />, text: "Cultural Heritage" },
              { icon: <GiShoppingBag className="text-xl" />, text: "Shopping Paradise" },
              { icon: <FaTree className="text-xl" />, text: "Nature Adventures" }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <div className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-20">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Singapore & Malaysia Tour Packages</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience the best of both countries with our specially curated packages featuring exclusive cross-border experiences
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'popular', 'luxury', 'family', 'beach', 'cultural', 'adventure'].map((tab) => (
            <motion.button
              key={tab}
                        ...
                        >
                          <div className="pt-4 border-t border-blue-100">
                            <h4 className="font-semibold text-gray-800 mb-3 flex items-center">
                              <FaCity className="text-blue-500 mr-2" /> Package Highlights:
                            </h4>
        ...
        {filteredPackages.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-500 mb-6">Contact us to customize your perfect Singapore & Malaysia itinerary</p>
            <button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-3 rounded-full font-medium hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg">
              Enquire About Singapore & Malaysia Tours
            </button>
          </motion.div>
        )}
      </div>
            ...
            {[
              {
                ...
                description: "Seamless travel between Singapore and Malaysia",
                icon: "🌏",
                bg: "bg-blue-100"
              },
              {
                title: "Local Guides",
                description: "Expert guides in both countries",
                icon: "👨‍💼",
                bg: "bg-purple-100"
              },
              {
                title: "Hassle-Free Experience",
                description: "Border crossing assistance and coordination",
                icon: "⚡",
                bg: "bg-indigo-100"
              }
            ].map((feature, index) => (
      ...
      {/* Singapore & Malaysia Images Gallery */}
      <div className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Explore Two Countries</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {galleryImages.map((image, index) => (
              ...
              >
                <img 
                  src={image} 
                  alt={`Singapore Malaysia scenery ${index + 1}`} 
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="beach" className="ml-2 block text-sm text-gray-700">
                            Beach Activities
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="cultural" className="ml-2 block text-sm text-gray-700">
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            checked={formData.specialRequests.universalStudios}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="universalStudios" className="ml-2 block text-sm text-gray-700">
                            Universal Studios
                          </label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input
                            ...
                            checked={formData.specialRequests.gentingHighlands}
                            onChange={handleSpecialRequestChange}
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                          />
                          <label htmlFor="gentingHighlands" className="ml-2 block text-sm text-gray-700">
                            Genting Highlands
                          </label>
                        </div>
